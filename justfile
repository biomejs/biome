...
# Creates a new tailwind lint rule with the given name. Name has to be camel case.
new-tailwind-lintrule rulename:
  cargo run -p xtask_codegen -- new-lintrule --kind=tailwind --category=lint --name={{rulename}}
  just gen-analyzer
