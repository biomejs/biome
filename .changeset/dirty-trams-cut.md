...
Biome's type inference now narrows the type of a variable inside the consequent of an `if (typeof x === "...")` guard ([#8333](https://github.com/biomejs/biome/issues/8333)).
