			...
			sidebar: [
				{
					label: "Blog",
					link: "../blog",
					translations: { ja: "ブログ", "zh-CN": "博客", id: "Blog" },
				},
				{
					label: "Playground",
					link: "../playground",
					...
					items: [
						...
						},
						{
							...
							translations: {
								...
								id: "Menggunakan Biome di proyek besar",
							},
						},
						{
						...
						},
						{
							...
							translations: {
								...
								id: "Integrasi Biome di editor Anda",
							},
						},
					],
				},
