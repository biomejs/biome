...
title: Biome
template: splash
description: 瞬间完成format、lint等！
hero:
  title: Web项目的唯一工具链
  tagline: 瞬间完成format、lint等！
  image:
    alt: Biome，Web工具链
...
banner:
  content: |
    Biome赢得了 <a href="/blog/biome-wins-prettier-challenge">Prettier挑战</a> 的奖金！
---
...
<CardGrid stagger>
  <Card title="快速" icon="rocket">
    使用Rust构建，灵感来自rust-analyzer的革命性架构。
  </Card>
  ...
  <Card title="一应俱全" icon="add-document">
    开箱即用，支持前端开发中的各各种语言特性。尤其对TypeScript与JSX提供完美支持。
  </Card>
</CardGrid>
