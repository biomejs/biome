...
We recommend installing an editor plugin to get the most out of Biome. Check the [editor page](/guides/integrate-in-editor) to know which editors support Biome.
