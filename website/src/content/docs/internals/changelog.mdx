...
- Fix [#1173](https://github.com/biomejs/biome/issues/1173). Fix the formatting of a single commented instruction within a control flow body to ensure consistency. Contributed by @mdm317
