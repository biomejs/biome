...
| [YAML](https://github.com/biomejs/biome/issues/2365) | <span aria-label="In progress" role="img">⌛️</span> | <span aria-label="In Progress" role="img">⌛️</span> | <span aria-label="In Progress" role="img">⌛️</span> |
| [GraphQL](https://github.com/biomejs/biome/issues/1927) | <span aria-label="In progress" role="img">⌛️</span> | <span aria-label="In Progress" role="img">⌛️</span> | <span aria-label="In Progress" role="img">⌛️</span> |
