...
<pre class="language-text"><code class="language-text">correctness/noVoidElementsWithChildren.jsx:1:1 <a href="https://biomejs.dev/linter/rules/no-void-elements-with-children">lint/correctness/noVoidElementsWithChildren</a> <span style="color: #000; background-color: #ddd;"> FIXABLE </span> ━━━━━━━━━━
