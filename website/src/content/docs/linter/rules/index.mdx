...
| [noNodeModules](/linter/rules/no-node-modules) | Forbid the use of Node.js builtin modules. |  |
...
| [useNodeImportProtocol](/linter/rules/use-node-import-protocol) | Enforces using the <code>node:</code> protocol for Node.js builtin modules. | <span aria-label="The rule has an unsafe fix" role="img" title="The rule has an unsafe fix">⚠️ </span> |
| [useNumberProperties](/linter/rules/use-number-properties) | Use <code>Number</code> properties instead of global ones. | <span aria-label="The rule has an unsafe fix" role="img" title="The rule has an unsafe fix">⚠️ </span> |
