...
| [noExclusiveTests](/linter/rules/no-exclusive-tests) | Disallow exclusive tests. | <span aria-label="The rule has an unsafe fix" role="img" title="The rule has an unsafe fix">⚠️ </span> |
