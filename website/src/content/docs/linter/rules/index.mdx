...
| [noDoneCallback](/linter/rules/no-done-callback) | This rule checks the function parameter of hooks &amp; tests for use of the done argument, suggesting you return a promise instead. |  |
