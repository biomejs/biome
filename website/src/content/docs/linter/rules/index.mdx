...
| [noInteractiveElementToNoninteractiveRole](/linter/rules/no-interactive-element-to-noninteractive-role) | Succinct description of the rule. |  |
...
| [useAriaActivedescendantTabindex](/linter/rules/use-aria-activedescendant-tabindex) | Enforce that <code>tabIndex</code> is assigned to non-interactive HTML elements with <code>aria-activedescendant</code>. |  |
