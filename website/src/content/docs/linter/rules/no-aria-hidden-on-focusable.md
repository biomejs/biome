...
<strong><span style="color: Tomato;">  </span></strong><strong><span style="color: Tomato;">✖</span></strong> <span style="color: Tomato;">Disallow `aria-hidden='true'` from being set on focusable elements.</span>
...
<strong><span style="color: lightgreen;">  </span></strong><strong><span style="color: lightgreen;">ℹ</span></strong> <span style="color: lightgreen;">`aria-hidden` must not be set to `true` on focusable elements.</span>
