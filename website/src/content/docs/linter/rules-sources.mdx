...
| [no-delete-var](https://eslint.org/docs/latest/rules/no-delete-var) |[noDelete](/linter/rules/no-delete) |
...
| [no-return-assign](https://eslint.org/docs/latest/rules/no-return-assign) |[noAssignInExpressions](/linter/rules/no-assign-in-expressions) |
...
| [no-static-only-class](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-static-only-class) |[noStaticOnlyClass](/linter/rules/no-static-only-class) |
| [no-typeof-undefined](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-typeof-undefined) |[useValidTypeof](/linter/rules/use-valid-typeof) |
