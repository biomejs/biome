...
que implementa o padrão [Árvore Verde e Vermelha].
...
0: JS_MODULE@0..55
    ...
      1: SEMICOLON@15..27 ";" [] [Espaço(" "), Comentários("// comentário 1")]
    1: JS_VARIABLE_STATEMENT@27..55
        ...
        1: CONST_KW@27..45 "const" [NovaLinha("\n"), Comentários("// comentário 2"), NovaLinha("\n")] [Espaço(" ")]
  3: EOF@55..55 "" [] []
```

O CST nunca é diretamente acessível por design, um desenvolvedor pode ler suas informações usando a Árvore Vermelha, usando uma série de APIs que são geradas automaticamente a partir da gramática do idioma.


#### Parser resiliente e recuperável

Para construir um CST, é necessário um parser resiliente e recuperável:
- resiliente: um parser capaz de retomar a análise após encontrar um erro de sintaxe pertencente ao idioma;
...
JsModule {
  ...
  items: JsModuleItemList [
    JsWhileStatement {
      while_token: WHILE_KW@0..6 "while" [] [Espaço(" ")],
...
main.tsx:1:7 parse ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ✖ esperado `(` mas em vez disso encontrou `{`
...
main.tsx:1:9 parse ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ✖ esperado um nome para a função em uma declaração de função, mas não encontrou nenhum
...
[Árvore Verde e Vermelha]: https://learn.microsoft.com/en-us/archive/blogs/ericlippert/persistence-facades-and-roslyns-red-green-trees
