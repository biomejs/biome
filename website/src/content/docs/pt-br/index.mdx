...
hero:
  title: Uma toolchain para seu projeto web
...
banner:
  content: |
    Biome ganhou a recompensa do <a href="/blog/biome-wins-prettier-challenge">desafio do Prettier</a>!
---
...
<CardGrid stagger>
  ...
  <Card title="Prático e informativo" icon="information">
    Esqueça aquelas mensagens de erro obscuras! Quando alguma coisa tá errada,
    nós falamos exatamente o que está errado e como concertar!
  </Card>
