...
- Abra a _Sobreposição de Abertura Rápida_ (<kbd>Ctrl</kbd>/<kbd title="Cmd">⌘</kbd>+<kbd>P</kbd> ou _Ir -> Ir para Arquivo_), digite `ext install biomejs.biome` e pressione enter.
