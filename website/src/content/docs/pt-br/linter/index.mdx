...
O Linter do Biome analiza de forma estática o seu código para encontrar erros comuns e ajudar você a escrever códigos idiomáticos.
...
3. Falar para o usuário o que ele precisa fazer. Geralmente, isso é implementado usando um "code action". Se o "code action" não for aplicável uma nota deve dizer o que o usuário precisa fazer para arrumar o erro.
...
Para aplicar _correções seguras_, utitlize o parâmetro `--apply`:
