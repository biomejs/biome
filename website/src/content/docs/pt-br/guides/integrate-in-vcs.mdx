...
Essa configuração não faz **qualquer coisa em si**. Você precisa adicionar novos recursos.

### Ignorando arquivos

Isso é um recurso que permite que o Biome leia os arquivos ignorados do VCS e ignora todos os arquivos e pastas especificados nele. Esse é um recurso opcional, e você precisa ativar o campo `vcs.useIgnoreFile`:
