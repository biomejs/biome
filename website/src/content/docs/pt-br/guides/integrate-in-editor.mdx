...
- [`sublime text`](http://www.sublimetext.com/): siga as instruções de instalação do [`LSP-biome`](https://github.com/sublimelsp/LSP-biome)
...
- Um [daemon](/pt-br/internals/architecture#daemon) que executa as operações sollicitadas;
