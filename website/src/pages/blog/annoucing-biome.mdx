...
The team wanted to create a second "Rome", a second version of it. So we fused the words "Bis" and "Rome". **Biome"". [Jamie](https://github.com/jamiebuilds) is the one that came up with idea, who kindly gave us his blessing for using it.
...
- [Jamie](https://github.com/jamiebuilds): former CTO of Rome Tools Inc., he's the person that came up with the name Biome in the first place;
