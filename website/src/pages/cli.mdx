...
```
# Nix derivation example; the binary path comes from "${pkgs.rome}/bin/rome"
ROME_BINARY=/nix/store/68fyfw1hidsqkal1839whi3nzgvqv4pa-rome-12.1.0/bin/rome npx rome format .
```
