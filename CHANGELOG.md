...
- Add [useAriaActivedescendantTabindex](https://biomejs.dev/linter/rules/use-aria-activedescendant-tabindex) rule. The rule Enforce that `tabIndex` is assigned to non-interactive HTML elements with `aria-activedescendant`. Contributed by @nissy-dev
