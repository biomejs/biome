...
- Add rule [noUnusedDependencies](https://biomejs.dev/linter/rules/no-unused-dependencies), to detect the use of dependencies that aren't present in the `package.json`
