...
See https://biomejs.dev/linter/rules/use-consistent-error-subclassing 
	 */
	useConsistentErrorSubclassing?: UseConsistentErrorSubclassingConfiguration;
	/**
...
export type UseConsistentErrorSubclassingConfiguration =
	| RulePlainConfiguration
	| RuleWithUseConsistentErrorSubclassingOptions;
...
export interface RuleWithUseConsistentErrorSubclassingOptions {
	level: RulePlainConfiguration;
	options?: UseConsistentErrorSubclassingOptions;
}
...
export type UseConsistentErrorSubclassingOptions = {};
/**
...
export type Category =
	...
	| "lint/nursery/useConsistentErrorSubclassing"
