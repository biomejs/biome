...
For comment and rustdoc style, see the [doc-comments](../doc-comments/SKILL.md) skill. It defines who the reader is, the separate jobs of `//` / `///` / `//!`, the deletion test, and the banned patterns. Do not duplicate that guidance here.
