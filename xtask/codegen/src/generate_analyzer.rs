...
fn generate_group(category: &'static str, group: &str, base_path: &Path) -> Result<()> {
    ...
    let tokens = reformat(quote! {
        ...
        //!
        //! To add a new rule, create a `.rs` file or a directory containing
        //! `mod.rs` in the group subdirectory and run `cargo check`. The build
        //! system will automatically discover and register your rule.
