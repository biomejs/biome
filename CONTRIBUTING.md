...
1. [ ] Replace all `version: "next"` to the new version number in the metadata of the rules. This should be automated , but you can use `scripts/update-next-version.sh` if you need to do it manually.
