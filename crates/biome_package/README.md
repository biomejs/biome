...
[cargo-badge]: https://badgen.net/crates/v/biome_package?&color=green
[cargo-url]: https://crates.io/crates/biome_package/

</div>

# `biome_package`

Workspace package handler. Follow the [documentation](https://docs.rs/biome_package/).
