use crate::keywords::{
    AT_RULES_KEYWORDS, AT_RULE_PAGE_PSEUDO_CLASSES, A_NPLUS_BNOTATION_PSEUDO_CLASSES,
    A_NPLUS_BOF_SNOTATION_PSEUDO_CLASSES, BASIC_KEYWORDS, CONDITIONAL_AT_RULES,
    FONT_FAMILY_KEYWORDS, FONT_FEATURE_VALUE_TYPES, FONT_SIZE_KEYWORDS, FONT_STRETCH_KEYWORDS,
    FONT_STYLE_KEYWORDS, FONT_VARIANTS_KEYWORDS, FONT_WEIGHT_ABSOLUTE_KEYWORDS,
    FONT_WEIGHT_NUMERIC_KEYWORDS, FUNCTION_KEYWORDS, HTML_TAGS, KNOWN_CHROME_PROPERTIES,
    ...
    PAGE_MARGIN_AT_KEYWORDS, RESET_TO_INITIAL_PROPERTIES_BY_BORDER,
    RESET_TO_INITIAL_PROPERTIES_BY_FONT, RESOURCE_STATE_PSEUDO_CLASSES,
    SHADOW_TREE_PSEUDO_ELEMENTS, SHORTHAND_PROPERTIES, SVG_TAGS, SYSTEM_FAMILY_NAME_KEYWORDS,
...
pub fn is_at_rule_keywords(value: &str) -> bool {
    CONDITIONAL_AT_RULES.binary_search(&value).is_ok()
        || PAGE_MARGIN_AT_KEYWORDS.binary_search(&value).is_ok()
        || FONT_FEATURE_VALUE_TYPES.binary_search(&value).is_ok()
        || AT_RULES_KEYWORDS.binary_search(&value).is_ok()
}
