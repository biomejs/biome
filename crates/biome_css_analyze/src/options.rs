...
pub type NoEmptyComment =
    <lint::nursery::no_empty_comment::NoEmptyComment as biome_analyze::Rule>::Options;
...
pub type NoIrregularWhitespaceCss = < lint :: nursery :: no_irregular_whitespace_css :: NoIrregularWhitespaceCss as biome_analyze :: Rule > :: Options ;
