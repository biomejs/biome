...
tests_macros::gen_tests! {"tests/specs/**/*.{css,scss,json,jsonc,svelte,vue,html,astro}", crate::run_test, "module"}
...
fn run_test(input: &'static str, _: &str, _: &str, _: &str) {
    ...
    let snapshot = if matches!(extension, "vue" | "svelte" | "astro" | "html") {
