...
pub enum GraphqlSyntaxKind {
    ...
    REPEATABLE_KW,
    QUERY_UPPERCASE_KW,
    MUTATION_UPPERCASE_KW,
    SUBSCRIPTION_UPPERCASE_KW,
    FIELD_UPPERCASE_KW,
...
impl GraphqlSyntaxKind {
    ...
    pub fn from_keyword(ident: &str) -> Option<GraphqlSyntaxKind> {
        let kw = match ident {
            ...
            "QUERY" => QUERY_UPPERCASE_KW,
            "MUTATION" => MUTATION_UPPERCASE_KW,
            "SUBSCRIPTION" => SUBSCRIPTION_UPPERCASE_KW,
            "FIELD" => FIELD_UPPERCASE_KW,
            ...
            "SCHEMA" => SCHEMA_UPPERCASE_KW,
            "SCALAR" => SCALAR_UPPERCASE_KW,
            "OBJECT" => OBJECT_UPPERCASE_KW,
            "FIELD_DEFINITION" => FIELD_DEFINITION_KW,
            "ARGUMENT_DEFINITION" => ARGUMENT_DEFINITION_KW,
            "INTERFACE" => INTERFACE_UPPERCASE_KW,
            "UNION" => UNION_UPPERCASE_KW,
            "ENUM" => ENUM_UPPERCASE_KW,
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            QUERY_UPPERCASE_KW => "QUERY",
            MUTATION_UPPERCASE_KW => "MUTATION",
            SUBSCRIPTION_UPPERCASE_KW => "SUBSCRIPTION",
            FIELD_UPPERCASE_KW => "FIELD",
            ...
            SCHEMA_UPPERCASE_KW => "SCHEMA",
            SCALAR_UPPERCASE_KW => "SCALAR",
            OBJECT_UPPERCASE_KW => "OBJECT",
            FIELD_DEFINITION_KW => "FIELD_DEFINITION",
            ARGUMENT_DEFINITION_KW => "ARGUMENT_DEFINITION",
            INTERFACE_UPPERCASE_KW => "INTERFACE",
            UNION_UPPERCASE_KW => "UNION",
            ENUM_UPPERCASE_KW => "ENUM",
...
#[macro_export]
macro_rules ! T { [!] => { $ crate :: GraphqlSyntaxKind :: BANG } ; [$] => { $ crate :: GraphqlSyntaxKind :: DOLLAR } ; [&] => { $ crate :: GraphqlSyntaxKind :: AMP } ; ['('] => { $ crate :: GraphqlSyntaxKind :: L_PAREN } ; [')'] => { $ crate :: GraphqlSyntaxKind :: R_PAREN } ; [...] => { $ crate :: GraphqlSyntaxKind :: DOT3 } ; [:] => { $ crate :: GraphqlSyntaxKind :: COLON } ; [=] => { $ crate :: GraphqlSyntaxKind :: EQ } ; [@] => { $ crate :: GraphqlSyntaxKind :: AT } ; ['['] => { $ crate :: GraphqlSyntaxKind :: L_BRACK } ; [']'] => { $ crate :: GraphqlSyntaxKind :: R_BRACK } ; ['{'] => { $ crate :: GraphqlSyntaxKind :: L_CURLY } ; [|] => { $ crate :: GraphqlSyntaxKind :: PIPE } ; ['}'] => { $ crate :: GraphqlSyntaxKind :: R_CURLY } ; [true] => { $ crate :: GraphqlSyntaxKind :: TRUE_KW } ; [false] => { $ crate :: GraphqlSyntaxKind :: FALSE_KW } ; [query] => { $ crate :: GraphqlSyntaxKind :: QUERY_KW } ; [mutation] => { $ crate :: GraphqlSyntaxKind :: MUTATION_KW } ; [subscription] => { $ crate :: GraphqlSyntaxKind :: SUBSCRIPTION_KW } ; [fragment] => { $ crate :: GraphqlSyntaxKind :: FRAGMENT_KW } ; [on] => { $ crate :: GraphqlSyntaxKind :: ON_KW } ; [null] => { $ crate :: GraphqlSyntaxKind :: NULL_KW } ; [schema] => { $ crate :: GraphqlSyntaxKind :: SCHEMA_KW } ; [extend] => { $ crate :: GraphqlSyntaxKind :: EXTEND_KW } ; [scalar] => { $ crate :: GraphqlSyntaxKind :: SCALAR_KW } ; [type] => { $ crate :: GraphqlSyntaxKind :: TYPE_KW } ; [implements] => { $ crate :: GraphqlSyntaxKind :: IMPLEMENTS_KW } ; [interface] => { $ crate :: GraphqlSyntaxKind :: INTERFACE_KW } ; [union] => { $ crate :: GraphqlSyntaxKind :: UNION_KW } ; [enum] => { $ crate :: GraphqlSyntaxKind :: ENUM_KW } ; [input] => { $ crate :: GraphqlSyntaxKind :: INPUT_KW } ; [directive] => { $ crate :: GraphqlSyntaxKind :: DIRECTIVE_KW } ; [repeatable] => { $ crate :: GraphqlSyntaxKind :: REPEATABLE_KW } ; [QUERY_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: QUERY_UPPERCASE_KW } ; [MUTATION_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: MUTATION_UPPERCASE_KW } ; [SUBSCRIPTION_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: SUBSCRIPTION_UPPERCASE_KW } ; [FIELD_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: FIELD_UPPERCASE_KW } ; [FRAGMENT_DEFINITION] => { $ crate :: GraphqlSyntaxKind :: FRAGMENT_DEFINITION_KW } ; [FRAGMENT_SPREAD] => { $ crate :: GraphqlSyntaxKind :: FRAGMENT_SPREAD_KW } ; [INLINE_FRAGMENT] => { $ crate :: GraphqlSyntaxKind :: INLINE_FRAGMENT_KW } ; [VARIABLE_DEFINITION] => { $ crate :: GraphqlSyntaxKind :: VARIABLE_DEFINITION_KW } ; [SCHEMA_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: SCHEMA_UPPERCASE_KW } ; [SCALAR_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: SCALAR_UPPERCASE_KW } ; [OBJECT_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: OBJECT_UPPERCASE_KW } ; [FIELD_DEFINITION] => { $ crate :: GraphqlSyntaxKind :: FIELD_DEFINITION_KW } ; [ARGUMENT_DEFINITION] => { $ crate :: GraphqlSyntaxKind :: ARGUMENT_DEFINITION_KW } ; [INTERFACE_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: INTERFACE_UPPERCASE_KW } ; [UNION_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: UNION_UPPERCASE_KW } ; [ENUM_UPPERCASE] => { $ crate :: GraphqlSyntaxKind :: ENUM_UPPERCASE_KW } ; [ENUM_VALUE] => { $ crate :: GraphqlSyntaxKind :: ENUM_VALUE_KW } ; [INPUT_OBJECT] => { $ crate :: GraphqlSyntaxKind :: INPUT_OBJECT_KW } ; [INPUT_FIELD_DEFINITION] => { $ crate :: GraphqlSyntaxKind :: INPUT_FIELD_DEFINITION_KW } ; [ident] => { $ crate :: GraphqlSyntaxKind :: IDENT } ; [EOF] => { $ crate :: GraphqlSyntaxKind :: EOF } ; [UNICODE_BOM] => { $ crate :: GraphqlSyntaxKind :: UNICODE_BOM } ; [#] => { $ crate :: GraphqlSyntaxKind :: HASH } ; }
