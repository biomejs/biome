...
use biome_css_syntax::CssSyntaxKind::{
    CSS_BOGUS_PROPERTY_VALUE, EOF, SCSS_EXPRESSION, SCSS_LIST_EXPRESSION,
    SCSS_EXPRESSION_ITEM_LIST, SCSS_LIST_EXPRESSION_ELEMENT, SCSS_LIST_EXPRESSION_ELEMENT_LIST,
