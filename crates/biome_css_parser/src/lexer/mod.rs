...
impl<'src> CssLexer<'src> {
    ...
    fn consume_identifier(&mut self) -> CssSyntaxKind {
        ...
        match &buf[..count] {
            ...
            b"angle" => ANGLE_KW,
            b"color" => COLOR_KW,
            b"custom-ident" => CUSTOM_IDENT_KW,
            b"image" => IMAGE_KW,
            b"integer" => INTEGER_KW,
            b"length" => LENGTH_KW,
            b"length-percentage" => LENGTH_PERCENTAGE_KW,
            b"percentage" => PERCENTAGE_KW,
            b"resolution" => RESOLUTION_KW,
            b"string" => STRING_KW,
            b"time" => TIME_KW,
            b"transform-function" => TRANSFORM_FUNCTION_KW,
            b"src" => SRC_KW,
            b"scope" => SCOPE_KW,
            b"import" => IMPORT_KW,
