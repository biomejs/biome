...
use biome_rule_options::no_constant_binary_expressions::NoConstantBinaryExpressionsOptions;
...
declare_lint_rule! {
    ...
    /// ```
    ///
    pub NoConstantBinaryExpressions {
        version: "2.0.0",
...
impl Rule for NoConstantBinaryExpressions {
    type Query = Semantic<Query>;
    type State = Issue;
    type Signals = Option<Self::State>;
    type Options = NoConstantBinaryExpressionsOptions;
