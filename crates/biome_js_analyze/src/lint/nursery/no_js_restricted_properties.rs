...
use biome_rule_options::no_js_restricted_properties::{
    NoJsRestrictedPropertiesOptions, RestrictedPropertyEntry,
};
...
impl Rule for NoJsRestrictedProperties {
    type Query = Ast<AnyRestrictedPropertyNode>;
    type State = RestrictedPropertyState;
    type Signals = Box<[Self::State]>;
    type Options = NoJsRestrictedPropertiesOptions;
