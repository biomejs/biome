...
use biome_rule_options::no_multiline_string::NoMultilineStringOptions;
...
declare_lint_rule! {
    ...
    /// Line 2`;
    /// ```
    pub NoMultilineString {
        version: "2.3.8",
        name: "noMultilineString",
        language: "js",
        recommended: false,
...
impl Rule for NoMultilineString {
    type Query = Ast<JsStringLiteralExpression>;
    type State = ();
    type Signals = Option<Self::State>;
    type Options = NoMultilineStringOptions;
