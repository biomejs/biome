...
use biome_rule_options::use_spread_over_apply::UseSpreadOverApplyOptions;
...
impl Rule for UseSpreadOverApply {
    type Query = Ast<JsCallExpression>;
    type State = (AnyJsExpression, AnyJsExpression);
    type Signals = Option<Self::State>;
    type Options = UseSpreadOverApplyOptions;
