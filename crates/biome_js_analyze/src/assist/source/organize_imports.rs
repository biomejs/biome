...
declare_source_rule! {
    ...
    ///   bare imports together with their neighbors, or set [`bareImports`](#bareimports) to
    ///   `"last"` to also move all bare imports to the end of the surrounding chunk.
...
impl Rule for OrganizeImports {
    ...
    fn run(ctx: &RuleContext<Self>) -> Self::Signals {
        ...
        // `bareImports: "last"` implies that bare imports participate in the sort.
        let sort_bare_imports = bare_imports_last || options.sort_bare_imports.unwrap_or_default();
