...
// Function parameters with default values referencing variables
const MAX_ATTEMPTS = 4;
const DEFAULT_NAME = 'Guest';
const DEFAULT_CONFIG = { timeout: 1000 };

const retry = (max = MAX_ATTEMPTS): void => {};
const welcome = (name = DEFAULT_NAME): string => `Hello ${name}`;
const setup = (config = DEFAULT_CONFIG): void => {};
function fetchData(attempts = MAX_ATTEMPTS): void {}
const process = (value = someVariable): void => {};
