/* should not generate diagnostics - env vars declared in globalPassThroughEnv */

// Global pass-through env from turbo.json globalPassThroughEnv
const acmeToken = process.env.ACME_AUTH_TOKEN;
const dbUrl = process.env.DATABASE_URL;

// Wildcard patterns in globalPassThroughEnv (ACME_CACHE_* matches any ACME_CACHE_ prefixed var)
