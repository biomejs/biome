<>
	...
	<div class="custom-layout bar flex h-screen items-center justify-center bg-gray-200 text-lg font-bold" />
	...
	<div class="custom-text foo my-2 text-2xl font-semibold underline" />
	<div class="custom-container bar flex-wrap items-start justify-between bg-purple-200 p-5 text-purple-700" />
	<div class="custom-border gap-8 border-l-4 border-indigo-500 bg-indigo-100 p-3 text-indigo-900" />
	{/* variant sorting */}
	...
	<div class="container py-4 text-red-500 group-hover:flex-col focus:bg-red-100 hover:focus:bg-red-200 has-[:visited]:flex print:text-red-50 [&nth-child(2)]:text-red-300 [&nth-child(3)]:text-red-200 [&nth-child(2)]:[&nth-child(6)]:text-red-200" />
	<div class="py-4 text-black group-first:text-yellow-400 checked:visited:bg-yellow-300 hover:text-red-400 focus:bg-sky-100 [&nth-child(1)]:group-first:text-red-100 [&nth-child(2)]:text-black [&nth-child(2)]:focus:text-red-100 [&nth-child(2)]:hover:focus:bg-red-900" />
	<div class="group-target:font-bold group-aria-disabled:bg-red-50 group-[:visited]:text-red-400" />
	<div class="text-red-400 group-aria-[sort=ascending]:text-yellow-200 group-has-[.custom-class]:focus:underline has-[:checked]:focus:bg-yellow-300 aria-[sort=ascending]:bg-red-300" />
</>;
