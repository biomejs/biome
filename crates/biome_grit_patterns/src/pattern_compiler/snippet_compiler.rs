...
fn nodes_from_trees(snippets: &[SnippetTree<GritTargetTree>]) -> Vec<GritTargetNode<'_>> {
...
fn node_from_tree(snippet: &SnippetTree<GritTargetTree>) -> Option<GritTargetNode<'_>> {
