...
pub fn native_kind_by_name(node_name: &str) -> Option<CssSyntaxKind> {
    match node_name {
        ...
        "ScssEachHeader" => lang::ScssEachHeader::KIND_SET.iter().next(),
        ...
        "ScssModuleMemberAccess" => lang::ScssModuleMemberAccess::KIND_SET.iter().next(),
        "ScssNamespacedVariable" => lang::ScssNamespacedVariable::KIND_SET.iter().next(),
        ...
        "ScssVariable" => lang::ScssVariable::KIND_SET.iter().next(),
        "ScssVariableDeclaration" => lang::ScssVariableDeclaration::KIND_SET.iter().next(),
...
pub fn native_slots_for_name(node_name: &str) -> &'static [(&'static str, u32)] {
    match node_name {
        ...
        "ScssNamespacedVariable" => &[("namespace", 0), ("name", 2)],
        ...
        "ScssVariable" => &[("name", 1)],
        "ScssVariableDeclaration" => &[("name", 0), ("value", 2), ("modifiers", 3)],
