...
pub fn legacy_kind_by_name(node_name: &str) -> Option<JsSyntaxKind> {
    match node_name {
...
pub fn native_kind_by_name(node_name: &str) -> Option<JsSyntaxKind> {
    match node_name {
        ...
        "JsSvelteGenericsRoot" => lang::JsSvelteGenericsRoot::KIND_SET.iter().next(),
...
pub fn native_slots_for_name(node_name: &str) -> &'static [(&'static str, u32)] {
    match node_name {
        ...
        "JsArrayBindingPattern" => &[("elements", 1)],
        "JsArrayBindingPatternElement" => &[("pattern", 0), ("init", 1)],
        "JsArrayBindingPatternRestElement" => &[("pattern", 1)],
        "JsArrayExpression" => &[("elements", 1)],
        "JsArrowFunctionExpression" => &[
            ("type_parameters", 1),
            ("parameters", 2),
            ("return_type_annotation", 3),
            ("body", 5),
        ],
        "JsAssignmentExpression" => &[("left", 0), ("right", 2)],
        "JsAwaitExpression" => &[("argument", 1)],
        "JsBinaryExpression" => &[("left", 0), ("right", 2)],
        "JsBlockStatement" => &[("statements", 1)],
        "JsBreakStatement" => &[("label", 1)],
        "JsCallArguments" => &[("args", 1)],
        "JsCallExpression" => &[("callee", 0), ("type_arguments", 2), ("arguments", 3)],
        "JsCaseClause" => &[("test", 1), ("consequent", 3)],
        "JsCatchClause" => &[("declaration", 1), ("body", 2)],
        "JsCatchDeclaration" => &[("binding", 1), ("type_annotation", 2)],
        "JsClassDeclaration" => &[
            ("decorators", 0),
            ("id", 3),
            ("type_parameters", 4),
        ...
        "JsComputedMemberAssignment" => &[("object", 0), ("member", 2)],
        "JsComputedMemberExpression" => &[("object", 0), ("member", 3)],
        "JsComputedMemberName" => &[("expression", 1)],
        "JsConditionalExpression" => &[("test", 0), ("consequent", 2), ("alternate", 4)],
        ...
        "JsConstructorParameters" => &[("parameters", 1)],
        "JsContinueStatement" => &[("label", 1)],
        "JsDecorator" => &[("expression", 1)],
        "JsDefaultClause" => &[("consequent", 2)],
        "JsDefaultImportSpecifier" => &[("local_name", 0)],
        "JsDoWhileStatement" => &[("body", 1), ("test", 4)],
        "JsElseClause" => &[("alternate", 1)],
        "JsExport" => &[("decorators", 0), ("export_clause", 2)],
        "JsExportAsClause" => &[("exported_name", 1)],
        "JsExportDefaultDeclarationClause" => &[("declaration", 1)],
        "JsExportDefaultExpressionClause" => &[("expression", 1)],
        "JsExportFromClause" => &[("export_as", 2), ("source", 4), ("assertion", 5)],
        "JsExportNamedClause" => &[("specifiers", 2)],
        "JsExportNamedFromClause" => &[("specifiers", 2), ("source", 5), ("assertion", 6)],
        "JsExportNamedFromSpecifier" => &[("source_name", 1), ("export_as", 2)],
        "JsExportNamedShorthandSpecifier" => &[("name", 1)],
        "JsExportNamedSpecifier" => &[("local_name", 1), ("exported_name", 3)],
        "JsExpressionSnippet" => &[("expression", 0)],
        "JsExpressionStatement" => &[("expression", 0)],
        "JsExpressionTemplateRoot" => &[("expression", 0)],
        "JsExtendsClause" => &[("super_class", 1), ("type_arguments", 2)],
        "JsFinallyClause" => &[("body", 1)],
        "JsForInStatement" => &[("initializer", 2), ("expression", 4), ("body", 6)],
        "JsForOfStatement" => &[("initializer", 3), ("expression", 5), ("body", 7)],
        "JsForStatement" => &[("initializer", 2), ("test", 4), ("update", 6), ("body", 8)],
        "JsForVariableDeclaration" => &[("declarator", 2)],
        "JsFormalParameter" => &[
            ("decorators", 0),
            ("binding", 1),
            ("type_annotation", 3),
        ...
        "JsFunctionBody" => &[("directives", 1), ("statements", 2)],
        "JsFunctionDeclaration" => &[
            ("id", 3),
            ("type_parameters", 4),
            ("parameters", 5),
            ("return_type_annotation", 6),
            ("body", 7),
        ],
        ...
        "JsGetterObjectMember" => &[("name", 1), ("return_type", 4), ("body", 5)],
        "JsIdentifierExpression" => &[("name", 0)],
        "JsIfStatement" => &[("test", 2), ("consequent", 4), ("else_clause", 5)],
        "JsImport" => &[("import_clause", 1)],
        "JsImportAssertion" => &[("assertions", 2)],
        "JsImportBareClause" => &[("source", 0), ("assertion", 1)],
        "JsImportCallExpression" => &[("arguments", 3)],
        ...
        "JsImportDefaultClause" => &[("default_specifier", 2), ("source", 4), ("assertion", 5)],
        "JsImportNamedClause" => &[("named_specifiers", 1), ("source", 3), ("assertion", 4)],
        "JsImportNamespaceClause" => &[("namespace_specifier", 2), ("source", 4), ("assertion", 5)],
        "JsInExpression" => &[("property", 0), ("object", 2)],
        "JsInitializerClause" => &[("expression", 1)],
        "JsInstanceofExpression" => &[("left", 0), ("right", 2)],
        "JsLabeledStatement" => &[("label", 0), ("body", 2)],
        "JsLogicalExpression" => &[("left", 0), ("right", 2)],
        "JsMethodClassMember" => &[
            ("modifiers", 0),
            ("name", 3),
            ("type_parameters", 5),
            ("parameters", 6),
            ("return_type_annotation", 7),
            ("body", 8),
        ],
        "JsMethodObjectMember" => &[
            ...
            ("type_parameters", 3),
            ("parameters", 4),
            ("return_type_annotation", 5),
            ("body", 6),
        ],
        "JsModule" => &[("directives", 2), ("items", 3)],
        "JsNamedImportSpecifier" => &[("name", 1), ("local_name", 3)],
        "JsNamedImportSpecifiers" => &[("specifiers", 1)],
        "JsNamespaceImportSpecifier" => &[("local_name", 2)],
        "JsNewExpression" => &[("callee", 1), ("type_arguments", 2), ("arguments", 3)],
        "JsObjectAssignmentPattern" => &[("properties", 1)],
        "JsObjectAssignmentPatternProperty" => &[("member", 0), ("pattern", 2), ("init", 3)],
        "JsObjectAssignmentPatternRest" => &[("target", 1)],
        "JsObjectAssignmentPatternShorthandProperty" => &[("identifier", 0), ("init", 1)],
        "JsObjectBindingPattern" => &[("properties", 1)],
        "JsObjectBindingPatternProperty" => &[("member", 0), ("pattern", 2), ("init", 3)],
        "JsObjectBindingPatternRest" => &[("binding", 1)],
        "JsObjectBindingPatternShorthandProperty" => &[("identifier", 0), ("init", 1)],
        "JsObjectExpression" => &[("members", 1)],
        "JsParameters" => &[("items", 1)],
        "JsParenthesizedAssignment" => &[("assignment", 1)],
        "JsParenthesizedExpression" => &[("expression", 1)],
        "JsPostUpdateExpression" => &[("operand", 0)],
        "JsPreUpdateExpression" => &[("operand", 1)],
        "JsPropertyClassMember" => &[
            ("modifiers", 0),
            ("name", 1),
            ("property_annotation", 2),
            ("value", 3),
        ],
        "JsPropertyObjectMember" => &[("name", 0), ("value", 2)],
        "JsRestParameter" => &[("decorators", 0), ("binding", 2), ("type_annotation", 3)],
        "JsReturnStatement" => &[("argument", 1)],
        "JsScript" => &[("directives", 2), ("statements", 3)],
        "JsSequenceExpression" => &[("left", 0), ("right", 2)],
        "JsSetterClassMember" => &[("modifiers", 0), ("name", 2), ("parameter", 4), ("body", 7)],
        ...
        "JsSvelteGenericsRoot" => &[("type_parameters", 0)],
        "JsSvelteSnippetRoot" => &[("name", 0), ("parameters", 1)],
        "JsSwitchStatement" => &[("discriminant", 2), ("cases", 5)],
        "JsTemplateElement" => &[("expression", 1)],
        "JsTemplateExpression" => &[("tag", 0), ("type_arguments", 1), ("elements", 3)],
        "JsThrowStatement" => &[("argument", 1)],
        "JsTryFinallyStatement" => &[("body", 1), ("catch_clause", 2), ("finally_clause", 3)],
        "JsTryStatement" => &[("body", 1), ("catch_clause", 2)],
        "JsUnaryExpression" => &[("argument", 1)],
        "JsVariableDeclaration" => &[("declarators", 2)],
        ...
        "JsYieldExpression" => &[("argument", 1)],
        "JsxAttribute" => &[("name", 0), ("initializer", 1)],
        "JsxAttributeInitializerClause" => &[("value", 1)],
        ...
        "TsArrayType" => &[("element_type", 0)],
        "TsAsAssignment" => &[("assignment", 0), ("ty", 2)],
        "TsAsExpression" => &[("expression", 0), ("ty", 2)],
        "TsAssertsCondition" => &[("ty", 1)],
        "TsAssertsReturnType" => &[("parameter_name", 1), ("predicate", 2)],
        "TsCallSignatureTypeMember" => &[
            ("type_parameters", 0),
            ("parameters", 1),
            ("return_type_annotation", 2),
        ],
        "TsConditionalType" => &[
            ("check_type", 0),
            ("extends_type", 2),
        ...
        "TsConstructorSignatureClassMember" => &[("modifiers", 0), ("name", 1), ("parameters", 2)],
        "TsConstructorType" => &[
            ("type_parameters", 2),
            ("parameters", 3),
            ("return_type", 5),
        ],
        "TsDeclarationModule" => &[("directives", 2), ("items", 3)],
        "TsDeclareFunctionDeclaration" => &[
            ("id", 2),
            ("type_parameters", 3),
            ("parameters", 4),
        ...
        "TsDeclareStatement" => &[("declaration", 1)],
        "TsDefaultTypeClause" => &[("ty", 1)],
        "TsDefinitePropertyAnnotation" => &[("type_annotation", 1)],
        "TsDefiniteVariableAnnotation" => &[("type_annotation", 1)],
        "TsEnumDeclaration" => &[("id", 2), ("members", 4)],
        "TsEnumMember" => &[("name", 0), ("initializer", 1)],
        "TsExportAsNamespaceClause" => &[("name", 2)],
        "TsExportAssignmentClause" => &[("expression", 1)],
        "TsExportDeclareClause" => &[("declaration", 1)],
        "TsExtendsClause" => &[("types", 1)],
        "TsExternalModuleDeclaration" => &[("source", 1), ("body", 2)],
        "TsExternalModuleReference" => &[("source", 2)],
        "TsFunctionType" => &[
            ("type_parameters", 0),
            ("parameters", 1),
            ("return_type", 3),
        ],
        "TsGetterSignatureClassMember" => &[("modifiers", 0), ("name", 2), ("return_type", 5)],
        "TsGetterSignatureTypeMember" => &[("name", 1), ("type_annotation", 4)],
        "TsGlobalDeclaration" => &[("body", 1)],
        "TsImplementsClause" => &[("types", 1)],
        "TsImportEqualsDeclaration" => &[("id", 2), ("module_reference", 4)],
        "TsImportType" => &[
            ("arguments", 2),
            ("qualifier_clause", 3),
            ("type_arguments", 4),
        ],
        "TsImportTypeArguments" => &[("argument", 1), ("ts_import_type_assertion_block", 3)],
        "TsImportTypeAssertion" => &[("assertions", 3)],
        "TsImportTypeAssertionBlock" => &[("type_assertion", 1)],
        "TsImportTypeQualifier" => &[("right", 1)],
        "TsIndexSignatureClassMember" => {
            &[("modifiers", 0), ("parameter", 2), ("type_annotation", 4)]
        }
        "TsIndexSignatureParameter" => &[("binding", 0), ("type_annotation", 1)],
        "TsIndexSignatureTypeMember" => &[("parameter", 2), ("type_annotation", 4)],
        "TsIndexedAccessType" => &[("object_type", 0), ("index_type", 2)],
        "TsInferType" => &[("name", 1), ("constraint", 2)],
        "TsInitializedPropertySignatureClassMember" => {
            &[("modifiers", 0), ("name", 1), ("value", 3)]
        }
        "TsInstantiationExpression" => &[("expression", 0), ("arguments", 1)],
        ...
        "TsMethodSignatureTypeMember" => &[
            ...
            ("type_parameters", 2),
            ("parameters", 3),
            ("return_type_annotation", 4),
        ],
        "TsModuleBlock" => &[("items", 1)],
        "TsModuleDeclaration" => &[("name", 1), ("body", 2)],
        "TsNamedTupleTypeElement" => &[("name", 1), ("ty", 4)],
        "TsNonNullAssertionAssignment" => &[("assignment", 0)],
        "TsNonNullAssertionExpression" => &[("expression", 0)],
        "TsObjectType" => &[("members", 1)],
        "TsOptionalPropertyAnnotation" => &[("type_annotation", 1)],
        "TsOptionalTupleTypeElement" => &[("ty", 0)],
        "TsParenthesizedType" => &[("ty", 1)],
        "TsPredicateReturnType" => &[("parameter_name", 0), ("ty", 2)],
        "TsPropertyParameter" => &[("decorators", 0), ("modifiers", 1), ("formal_parameter", 2)],
        "TsPropertySignatureClassMember" => {
            &[("modifiers", 0), ("name", 1), ("property_annotation", 2)]
        }
        "TsPropertySignatureTypeMember" => &[("name", 1), ("type_annotation", 3)],
        "TsQualifiedModuleName" => &[("left", 0), ("right", 2)],
        "TsQualifiedName" => &[("left", 0), ("right", 2)],
        "TsReferenceType" => &[("name", 0), ("type_arguments", 1)],
        "TsRestTupleTypeElement" => &[("ty", 1)],
        "TsReturnTypeAnnotation" => &[("ty", 1)],
        "TsSatisfiesAssignment" => &[("assignment", 0), ("ty", 2)],
        "TsSatisfiesExpression" => &[("expression", 0), ("ty", 2)],
        "TsSetterSignatureClassMember" => &[("modifiers", 0), ("name", 2), ("parameter", 4)],
        "TsSetterSignatureTypeMember" => &[("name", 1), ("parameter", 3)],
        "TsTemplateElement" => &[("ty", 1)],
        "TsTemplateLiteralType" => &[("elements", 1)],
        "TsThisParameter" => &[("type_annotation", 1)],
        "TsTupleType" => &[("elements", 1)],
        "TsTypeAliasDeclaration" => &[("binding_identifier", 1), ("type_parameters", 2), ("ty", 4)],
        "TsTypeAnnotation" => &[("ty", 1)],
        "TsTypeArguments" => &[("ts_type_argument_list", 1)],
        "TsTypeAssertionAssignment" => &[("ty", 1), ("assignment", 3)],
        "TsTypeAssertionExpression" => &[("ty", 1), ("expression", 3)],
        "TsTypeConstraintClause" => &[("ty", 1)],
        "TsTypeOperatorType" => &[("ty", 1)],
        "TsTypeParameter" => &[
            ("modifiers", 0),
            ("name", 1),
            ("constraint", 2),
        ...
        "TsTypeParameters" => &[("items", 1)],
        "TsTypeofType" => &[("expression_name", 1), ("type_arguments", 2)],
        "TsUnionType" => &[("types", 1)],
        _ => &[],
    }
}
