...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ManifestModuleData {
    pub mappings: &'static [(&'static str, ModuleReplacementMapping)],
    pub replacements: &'static [(&'static str, ModuleReplacement)],
}
pub static MODULE_REPLACEMENTS_DATA: &[(&str, ManifestModuleData)] = &[
    (
        "micro-utilities",
        ManifestModuleData {
            mappings: &[
