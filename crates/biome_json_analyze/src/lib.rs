...
pub struct JsonAnalyzeServices {
    /// If the current file is a configuration, it will provide its source:
    /// - on the right of the tuple, the main `biome.json` (or its defaults)
    /// - on the left of the tuple, the `extends` configuration
