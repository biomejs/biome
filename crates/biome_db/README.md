...
[cargo-badge]: https://badgen.net/crates/v/biome_db?&color=green
[cargo-url]: https://crates.io/crates/biome_db/

</div>

# `biome_db`

Biome internal database. Follow the [documentation](https://docs.rs/biome_db/).
