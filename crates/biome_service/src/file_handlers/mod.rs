...
impl DocumentFileSource {
    ...
    const WELL_KNOWN_JSON_WITH_COMMENTS_AND_TRAILING_COMMAS_FILES: &'static [&'static str] = &[
        ...
        "babel.config.json",
        // Uses its own parser:
        // https://github.com/biomejs/biome/blob/5d5520a2dcd51b5657188c12112178193414846d/crates/biome_service/src/configuration/mod.rs#L339-L342
        "biome.jsonc",
        ...
        // Uses its own parser
        // https://github.com/microsoft/TypeScript/blob/dc113f8170bc9408961e4e89f1ffadf3dff5a41b/src/compiler/commandLineParser.ts#L2111-L2117
        // https://github.com/microsoft/TypeScript/blob/dc113f8170bc9408961e4e89f1ffadf3dff5a41b/src/compiler/parser.ts#L2185
        "tsconfig.json",
