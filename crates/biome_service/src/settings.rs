...
pub fn to_override_settings(
    ...
    for mut pattern in overrides.0 {
        ...
        let formatter = to_overrides_format_settings(formatter, &current_settings.formatter);
        ...
        let organize_imports = to_overrides_organize_imports_settings(
            organize_imports,
...
pub(crate) fn to_overrides_format_settings(
...
fn to_overrides_organize_imports_settings(
