...
pub struct Nursery {
    ...
    #[doc = "Disallow exclusive tests."]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub no_exclusive_tests: Option<RuleConfiguration<NoExclusiveTests>>,
...
impl Nursery {
    ...
    pub(crate) const GROUP_RULES: [&'static str; 40] = [
        "noBarrelFile",
        "noConsole",
        "noDuplicateJsonKeys",
    ...
    const ALL_RULES_AS_FILTERS: [RuleFilter<'static>; 40] = [
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[0]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[1]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[2]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[3]),
    ...
    pub(crate) fn get_enabled_rules(&self) -> IndexSet<RuleFilter> {
        ...
        if let Some(rule) = self.no_exclusive_tests.as_ref() {
            if rule.is_enabled() {
                index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[7]));
            }
        }
    ...
    pub(crate) fn all_rules_as_filters() -> [RuleFilter<'static>; 40] {
        Self::ALL_RULES_AS_FILTERS
    }
    #[doc = r" Select preset rules"]
    pub(crate) fn collect_preset_rules(
