    ...
    ($ node : expr , $ pattern : pat => $ body : expr) => {
        match $node {
            node => match $crate::JsSyntaxNode::kind(&node) {
                ...
                $crate::JsSyntaxKind::JS_SVELTE_GENERICS_ROOT => {
                    let $pattern = unsafe { $crate::JsSvelteGenericsRoot::new_unchecked(node) };
                    $body
                }
                ...
                $crate::JsSyntaxKind::JSX_SPREAD_CHILD => {
                    let $pattern = unsafe { $crate::JsxSpreadChild::new_unchecked(node) };
                    $body
                }
                ...
                $crate::JsSyntaxKind::JS_BOGUS_ROOT => {
                    let $pattern = unsafe { $crate::JsBogusRoot::new_unchecked(node) };
                    $body
                }
