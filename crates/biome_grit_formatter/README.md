...
[cargo-badge]: https://badgen.net/crates/v/biome_grit_formatter?&color=green
[cargo-url]: https://crates.io/crates/biome_grit_formatter/

</div>

# `biome_grit_formatter`

Biome's GritQL formatter. Follow the [documentation](https://docs.rs/biome_grit_formatter/).
