...
impl YamlDocument {
    pub fn with_content(self, element: Option<AnyYamlNode>) -> Self {
...
impl YamlMapping {
    ...
    pub fn with_entries(self, element: YamlMappingEntries) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl YamlMappingEntry {
    pub fn with_key(self, element: YamlScalar) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl YamlScalar {
    pub fn with_SCALAR_VALUE_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl YamlSequence {
    ...
    pub fn with_elements(self, element: YamlSequenceElements) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
