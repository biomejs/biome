...
impl YamlBlockMapping {
    ...
    pub fn as_fields(&self) -> YamlBlockMappingFields {
        YamlBlockMappingFields {
            yaml_indent: self.yaml_indent(),
            entries: self.entries(),
            yaml_dedent: self.yaml_dedent(),
        }
    }
    pub fn yaml_indent(&self) -> SyntaxResult<YamlIndent> {
        support::required_node(&self.syntax, 0usize)
    }
    pub fn entries(&self) -> YamlBlockMapEntryList {
        support::list(&self.syntax, 1usize)
    }
    pub fn yaml_dedent(&self) -> Option<YamlDedent> {
...
pub struct YamlBlockMappingFields {
    pub yaml_indent: SyntaxResult<YamlIndent>,
    pub entries: YamlBlockMapEntryList,
    pub yaml_dedent: Option<YamlDedent>,
}
#[derive(Clone, PartialEq, Eq, Hash)]
...
impl YamlBlockSequence {
    ...
    pub fn yaml_indent(&self) -> Option<YamlIndent> {
        support::node(&self.syntax, 0usize)
    }
...
pub struct YamlBlockSequenceFields {
    pub yaml_indent: Option<YamlIndent>,
...
impl YamlDedent {
    ...
    pub fn as_fields(&self) -> YamlDedentFields {
        YamlDedentFields {
            value_token: self.value_token(),
        }
    }
...
impl YamlIndent {
    ...
    pub fn as_fields(&self) -> YamlIndentFields {
        YamlIndentFields {
            value_token: self.value_token(),
        }
    }
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let result = if current_depth < 16 {
            ...
            f.debug_struct("YamlBlockMapping")
                .field(
                    "yaml_indent",
                    &support::DebugSyntaxResult(self.yaml_indent()),
                )
                .field("entries", &self.entries())
                .field(
                    "yaml_dedent",
                    &support::DebugOptionalElement(self.yaml_dedent()),
                )
                .finish()
        } else {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let result = if current_depth < 16 {
            ...
            f.debug_struct("YamlBlockSequence")
                .field(
                    "yaml_indent",
                    &support::DebugOptionalElement(self.yaml_indent()),
                )
                .field("entries", &self.entries())
                .field(
                    "yaml_dedent",
...
impl AstNode for YamlDedent {
    type Language = Language;
    const KIND_SET: SyntaxKindSet<Language> =
        SyntaxKindSet::from_raw(RawSyntaxKind(YAML_DEDENT as u16));
    fn can_cast(kind: SyntaxKind) -> bool {
        kind == YAML_DEDENT
    }
    fn cast(syntax: SyntaxNode) -> Option<Self> {
...
impl std::fmt::Debug for YamlDedent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        thread_local! { static DEPTH : std :: cell :: Cell < u8 > = const { std :: cell :: Cell :: new (0) } };
        let current_depth = DEPTH.get();
        let result = if current_depth < 16 {
            DEPTH.set(current_depth + 1);
            f.debug_struct("YamlDedent")
                .field(
                    "value_token",
                    &support::DebugSyntaxResult(self.value_token()),
                )
            ...
            f.debug_struct("YamlDedent").finish()
        };
        DEPTH.set(current_depth);
        result
    }
}
impl From<YamlDedent> for SyntaxNode {
    fn from(n: YamlDedent) -> SyntaxNode {
        n.syntax
    }
}
impl From<YamlDedent> for SyntaxElement {
    fn from(n: YamlDedent) -> SyntaxElement {
        n.syntax.into()
    }
}
...
impl AstNode for YamlIndent {
    type Language = Language;
    const KIND_SET: SyntaxKindSet<Language> =
        SyntaxKindSet::from_raw(RawSyntaxKind(YAML_INDENT as u16));
    fn can_cast(kind: SyntaxKind) -> bool {
        kind == YAML_INDENT
    }
    fn cast(syntax: SyntaxNode) -> Option<Self> {
...
impl std::fmt::Debug for YamlIndent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        thread_local! { static DEPTH : std :: cell :: Cell < u8 > = const { std :: cell :: Cell :: new (0) } };
        let current_depth = DEPTH.get();
        let result = if current_depth < 16 {
            DEPTH.set(current_depth + 1);
            f.debug_struct("YamlIndent")
                .field(
                    "value_token",
                    &support::DebugSyntaxResult(self.value_token()),
                )
            ...
            f.debug_struct("YamlIndent").finish()
        };
        DEPTH.set(current_depth);
        result
    }
}
impl From<YamlIndent> for SyntaxNode {
    fn from(n: YamlIndent) -> SyntaxNode {
        n.syntax
    }
}
impl From<YamlIndent> for SyntaxElement {
    fn from(n: YamlIndent) -> SyntaxElement {
        n.syntax.into()
    }
}
...
impl std::fmt::Display for YamlDedent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        std::fmt::Display::fmt(self.syntax(), f)
    }
}
...
impl std::fmt::Display for YamlIndent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        std::fmt::Display::fmt(self.syntax(), f)
    }
}
