...
[cargo-badge]: https://badgen.net/crates/v/biome_glob?&color=green
[cargo-url]: https://crates.io/crates/biome_glob/

</div>

# `biome_glob`

<DESCRIPTION>. Follow the [documentation](https://docs.rs/biome_glob/).
