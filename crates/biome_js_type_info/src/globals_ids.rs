...
const PREDEFINED_TYPE_COUNT: usize = 83;
...
predefined_globals! {
    ...
    (ARRAY_FROM_COPY_ID, ARRAY_FROM_COPY_ID_NAME, ARRAY_FROM_COPY_ID_GLOBAL_TYPE_ID, GLOBAL_ARRAY_FROM_COPY_ID, "Array.from copy", Helper),
    (ARRAY_FROM_MAPPED_ID, ARRAY_FROM_MAPPED_ID_NAME, ARRAY_FROM_MAPPED_ID_GLOBAL_TYPE_ID, GLOBAL_ARRAY_FROM_MAPPED_ID, "Array.from mapped", Helper),
    (ARRAY_FROM_SOURCE_ID, ARRAY_FROM_SOURCE_ID_NAME, ARRAY_FROM_SOURCE_ID_GLOBAL_TYPE_ID, GLOBAL_ARRAY_FROM_SOURCE_ID, "Iterable<T> | ArrayLike<T>", Helper),
    (ARRAY_LIKE_ID, ARRAY_LIKE_ID_NAME, ARRAY_LIKE_ID_GLOBAL_TYPE_ID, GLOBAL_ARRAY_LIKE_ID, "ArrayLike", ManualGlobal),
    (ITERABLE_ID, ITERABLE_ID_NAME, ITERABLE_ID_GLOBAL_TYPE_ID, GLOBAL_ITERABLE_ID, "Iterable", ManualGlobal),
    (INSTANCEOF_ARRAY_LIKE_T_ID, INSTANCEOF_ARRAY_LIKE_T_ID_NAME, INSTANCEOF_ARRAY_LIKE_T_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_ARRAY_LIKE_T_ID, "instanceof ArrayLike<T>", Helper),
    (INSTANCEOF_ITERABLE_T_ID, INSTANCEOF_ITERABLE_T_ID_NAME, INSTANCEOF_ITERABLE_T_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_ITERABLE_T_ID, "instanceof Iterable<T>", Helper),
    (ARRAY_FROM_RESULT_ID, ARRAY_FROM_RESULT_ID_NAME, ARRAY_FROM_RESULT_ID_GLOBAL_TYPE_ID, GLOBAL_ARRAY_FROM_RESULT_ID, "Array.from result", Helper),
    ...
    (READONLY_ARRAY_ID, READONLY_ARRAY_ID_NAME, READONLY_ARRAY_ID_GLOBAL_TYPE_ID, _, "ReadonlyArray", ManualGlobal),
    (ITERATOR_ID, ITERATOR_ID_NAME, ITERATOR_ID_GLOBAL_TYPE_ID, _, "Iterator", ManualGlobal),
    (ITERATOR_RESULT_ID, ITERATOR_RESULT_ID_NAME, ITERATOR_RESULT_ID_GLOBAL_TYPE_ID, _, "IteratorResult", ManualGlobal),
    (ITERABLE_ITERATOR_ID, ITERABLE_ITERATOR_ID_NAME, ITERABLE_ITERATOR_ID_GLOBAL_TYPE_ID, _, "IterableIterator", ManualGlobal),
    (GENERATOR_ID, GENERATOR_ID_NAME, GENERATOR_ID_GLOBAL_TYPE_ID, _, "Generator", ManualGlobal),
    (READONLY_SET_ID, READONLY_SET_ID_NAME, READONLY_SET_ID_GLOBAL_TYPE_ID, _, "ReadonlySet", ManualGlobal),
    (READONLY_MAP_ID, READONLY_MAP_ID_NAME, READONLY_MAP_ID_GLOBAL_TYPE_ID, _, "ReadonlyMap", ManualGlobal),
