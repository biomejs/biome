...
define_global_type!(INSTANCEOF_ARRAY_T_ID, INSTANCEOF_ARRAY_T_ID_NAME, 6, "instanceof Array<T>");
define_global_type!(INSTANCEOF_ARRAY_U_ID, INSTANCEOF_ARRAY_U_ID_NAME, 7, "instanceof Array<U>");
define_global_type!(ARRAY_ID, ARRAY_ID_NAME, 8, "Array");
define_global_type!(ARRAY_FILTER_ID, ARRAY_FILTER_ID_NAME, 9, "Array.prototype.filter");
define_global_type!(ARRAY_FOREACH_ID, ARRAY_FOREACH_ID_NAME, 10, "Array.prototype.forEach");
...
define_global_type!(INSTANCEOF_PROMISE_ID, INSTANCEOF_PROMISE_ID_NAME, 13, "instanceof Promise");
define_global_type!(PROMISE_ID, PROMISE_ID_NAME, 14, "Promise");
define_global_type!(PROMISE_CONSTRUCTOR_ID, PROMISE_CONSTRUCTOR_ID_NAME, 15, "Promise.constructor");
define_global_type!(PROMISE_CATCH_ID, PROMISE_CATCH_ID_NAME, 16, "Promise.prototype.catch");
define_global_type!(PROMISE_FINALLY_ID, PROMISE_FINALLY_ID_NAME, 17, "Promise.prototype.finally");
define_global_type!(PROMISE_THEN_ID, PROMISE_THEN_ID_NAME, 18, "Promise.prototype.then");
define_global_type!(PROMISE_ALL_ID, PROMISE_ALL_ID_NAME, 19, "Promise.all");
define_global_type!(PROMISE_ALL_SETTLED_ID, PROMISE_ALL_SETTLED_ID_NAME, 20, "Promise.allSettled");
...
define_global_type!(PROMISE_REJECT_ID, PROMISE_REJECT_ID_NAME, 23, "Promise.reject");
define_global_type!(PROMISE_RESOLVE_ID, PROMISE_RESOLVE_ID_NAME, 24, "Promise.resolve");
define_global_type!(PROMISE_TRY_ID, PROMISE_TRY_ID_NAME, 25, "Promise.try");
define_global_type!(BIGINT_STRING_LITERAL_ID, BIGINT_STRING_LITERAL_ID_NAME, 26, "\"bigint\"");
define_global_type!(BOOLEAN_STRING_LITERAL_ID, BOOLEAN_STRING_LITERAL_ID_NAME, 27, "\"boolean\"");
define_global_type!(FUNCTION_STRING_LITERAL_ID, FUNCTION_STRING_LITERAL_ID_NAME, 28, "\"function\"");
define_global_type!(NUMBER_STRING_LITERAL_ID, NUMBER_STRING_LITERAL_ID_NAME, 29, "\"number\"");
define_global_type!(OBJECT_STRING_LITERAL_ID, OBJECT_STRING_LITERAL_ID_NAME, 30, "\"object\"");
define_global_type!(STRING_STRING_LITERAL_ID, STRING_STRING_LITERAL_ID_NAME, 31, "\"string\"");
define_global_type!(SYMBOL_STRING_LITERAL_ID, SYMBOL_STRING_LITERAL_ID_NAME, 32, "\"symbol\"");
define_global_type!(UNDEFINED_STRING_LITERAL_ID, UNDEFINED_STRING_LITERAL_ID_NAME, 33, "\"undefined\"");
define_global_type!(
...
define_global_type!(CONDITIONAL_CALLBACK_ID, CONDITIONAL_CALLBACK_ID_NAME, 37, "() => conditional");
define_global_type!(MAP_CALLBACK_ID, MAP_CALLBACK_ID_NAME, 38, "<U>(item: T) => U");
define_global_type!(VOID_CALLBACK_ID, VOID_CALLBACK_ID_NAME, 39, "() => void");
define_global_type!(FETCH_ID, FETCH_ID_NAME, 40, "fetch");
define_global_type!(INSTANCEOF_REGEXP_ID, INSTANCEOF_REGEXP_ID_NAME, 41, "instanceof RegExp");
