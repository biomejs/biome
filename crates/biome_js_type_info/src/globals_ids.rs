...
macro_rules! predefined_globals {
    ($(($id:ident, $id_name:ident, $global_type_id:ident, $resolved_id:ident, $name:literal, $role:ident $(,)?)),+ $(,)?) => {
...
/// Recursive helper of [`predefined_globals!`] that emits each row's ID, GlobalTypeId, name, and resolved global alias.
...
predefined_globals! {
    ...
    (TYPEOF_OPERATOR_RETURN_UNION_ID, TYPEOF_OPERATOR_RETURN_UNION_ID_NAME, TYPEOF_OPERATOR_RETURN_UNION_ID_GLOBAL_TYPE_ID, GLOBAL_TYPEOF_OPERATOR_RETURN_UNION_ID,
    ...
    (FETCH_ID, FETCH_ID_NAME, FETCH_ID_GLOBAL_TYPE_ID, GLOBAL_FETCH_ID, "fetch", HostManual),
    ...
    (INSTANCEOF_SYMBOL_ID, INSTANCEOF_SYMBOL_ID_NAME, INSTANCEOF_SYMBOL_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_SYMBOL_ID, "instanceof Symbol", Helper),
    ...
    (ASYNC_DISPOSABLE_ID, ASYNC_DISPOSABLE_ID_NAME, ASYNC_DISPOSABLE_ID_GLOBAL_TYPE_ID, GLOBAL_ASYNC_DISPOSABLE_ID, "AsyncDisposable", ManualGlobal),
    ...
    (INSTANCEOF_DATE_ID, INSTANCEOF_DATE_ID_NAME, INSTANCEOF_DATE_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_DATE_ID, "instanceof Date", Helper),
    (DATE_ID, DATE_ID_NAME, DATE_ID_GLOBAL_TYPE_ID, GLOBAL_DATE_ID, "Date", ManualGlobal),
    (INSTANCEOF_MAP_ID, INSTANCEOF_MAP_ID_NAME, INSTANCEOF_MAP_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_MAP_ID, "instanceof Map", Helper),
    (MAP_ID, MAP_ID_NAME, MAP_ID_GLOBAL_TYPE_ID, GLOBAL_MAP_ID, "Map", ManualGlobal),
    (INSTANCEOF_SET_ID, INSTANCEOF_SET_ID_NAME, INSTANCEOF_SET_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_SET_ID, "instanceof Set", Helper),
    (SET_ID, SET_ID_NAME, SET_ID_GLOBAL_TYPE_ID, GLOBAL_SET_ID, "Set", ManualGlobal),
    (INSTANCEOF_WEAK_MAP_ID, INSTANCEOF_WEAK_MAP_ID_NAME, INSTANCEOF_WEAK_MAP_ID_GLOBAL_TYPE_ID, GLOBAL_INSTANCEOF_WEAK_MAP_ID, "instanceof WeakMap", Helper),
