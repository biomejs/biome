...
pub use crate::interned_types::{
    ...
    InternedIndexedAccessType as InferredIndexedAccessType, InternedInterface as InferredInterface,
    InternedIntersection as InferredIntersection, InternedLiteral as InferredLiteral,
    InternedMappedType as InferredMappedType, InternedMergedReference as InferredMergedReference,
    ...
    LocalTypeId as InferredLocalTypeId, MappedTypeKeys as InferredMappedTypeKeys,
