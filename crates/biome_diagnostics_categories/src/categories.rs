...
define_categories! {
    ...
    "lint/nursery/noUndeclaredStyles": "https://biomejs.dev/linter/rules/no-undeclared-styles",
    ...
    "lint/nursery/noUnusedStyles": "https://biomejs.dev/linter/rules/no-unused-styles",
