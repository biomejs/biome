...
define_categories! {
    ...
    "lint/nursery/noDupeElseIfBlocks": "https://biomejs.dev/linter/rules/no-dupe-else-if-blocks",
    "lint/nursery/noDupeStyleProperties": "https://biomejs.dev/linter/rules/no-dupe-style-properties",
    "lint/nursery/noDupeUseDirectives": "https://biomejs.dev/linter/rules/no-dupe-use-directives",
