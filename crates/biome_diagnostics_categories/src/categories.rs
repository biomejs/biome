...
define_categories! {
    ...
    "lint/nursery/noSvelteDuplicateStyleProperties": "https://biomejs.dev/linter/rules/no-svelte-duplicate-style-properties",
    "lint/nursery/noSvelteDuplicateUseDirectives": "https://biomejs.dev/linter/rules/no-svelte-duplicate-use-directives",
