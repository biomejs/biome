...
define_categories! {
    ...
    "lint/nursery/noBiomeFirstException": "https://biomejs.dev/linter/rules/no-biome-first-exception",
    ...
    "lint/nursery/useBiomeIgnoreFolder": "https://biomejs.dev/linter/rules/use-biome-ignore-folder",
