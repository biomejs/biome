...
[cargo-badge]: https://badgen.net/crates/v/biome_graphql_parser?&color=green
[cargo-url]: https://crates.io/crates/biome_graphql_parser/

</div>

# `biome_graphql_parser`

Biome's GraphQL parser. Follow the [documentation](https://docs.rs/biome_graphql_parser/).
