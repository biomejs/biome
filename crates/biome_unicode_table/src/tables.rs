...
#![doc = "Generated from Unicode 17.0.0."]
...
pub mod html {
    const is_cjk_segment_break_character_table: &[(char, char)] = &[
        ('〈', '〉'),
        ('☰', '☷'),
        ('⚊', '⚏'),
        ('⺀', '⺙'),
    ...
    pub fn is_cjk_segment_break_character(c: char) -> bool {
        super::bsearch_range_table(c, is_cjk_segment_break_character_table)
    }
    const is_cjk_punctuation_table: &[(char, char)] = &[
        ('〈', '〉'),
        ('\u{3000}', '〃'),
        ('〈', '】'),
        ('〔', '〟'),
    ...
    pub fn is_cjk_punctuation(c: char) -> bool {
        super::bsearch_range_table(c, is_cjk_punctuation_table)
    }
    const is_default_ignorable_code_point_table: &[(char, char)] = &[
        ('\u{ad}', '\u{ad}'),
        ('\u{34f}', '\u{34f}'),
        ('\u{61c}', '\u{61c}'),
        ('\u{115f}', '\u{1160}'),
    ...
    pub fn is_default_ignorable_code_point(c: char) -> bool {
        super::bsearch_range_table(c, is_default_ignorable_code_point_table)
    }
}
