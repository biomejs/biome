...
declare_lint_rule! {
    ...
    /// - The directive has an argument. E.g. `<div v-once:aaa></div>`
    /// - The directive has any modifiers. E.g. `<div v-once.bbb></div>`
    /// - The directive has an attribute value. E.g. `<div v-once="foo"></div>`
    ///
    /// ## Examples
    ///
    /// ### Invalid
