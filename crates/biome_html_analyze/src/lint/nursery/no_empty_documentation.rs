...
fn leading_comments(
    syntax_node: &SyntaxNode<HtmlLanguage>,
) -> Vec<SyntaxTriviaPiece<HtmlLanguage>> {
...
fn is_empty_comment(trivia_piece: &SyntaxTriviaPiece<HtmlLanguage>) -> bool {
...
fn empty_comments(syntax_node: &SyntaxNode<HtmlLanguage>) -> Vec<TextRange> {
