...
declare_lint_rule! {
    ...
    /// - The directive has an argument. E.g. `<div v-pre:aaa></div>`
    /// - The directive has any modifiers. E.g. `<div v-pre.bbb></div>`
    /// - The directive has an attribute value. E.g. `<div v-pre="foo"></div>`
    ///
    /// ## Examples
    ///
    /// ### Invalid
