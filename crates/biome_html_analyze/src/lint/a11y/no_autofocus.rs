...
use biome_html_syntax::{AnyHtmlAttribute, HtmlElement, HtmlSelfClosingElement, T};
...
fn is_inside_allowed_context(attr: &AnyHtmlAttribute) -> Option<bool> {
...
fn is_dialog_or_popover(element: &AnyHtmlTagElement) -> bool {
    element.tag_name_kind() == Some(T![dialog])
