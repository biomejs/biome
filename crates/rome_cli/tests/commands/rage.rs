...
├─┘
├─16108ms INFO rome_lsp::server Starting Biome Language Server...
├─41801ms INFO rome_lsp::server Starting Biome Language Server...
...
├─┐rome_js_parser::parse::parse{file_id=FileId(1)}
├─┘
├─7897ms INFO rome_lsp::server Starting Biome Language Server...
"#,
