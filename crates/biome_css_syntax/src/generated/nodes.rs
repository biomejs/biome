...
impl AnyCssValueAtRuleImportSpecifier {
    ...
    pub fn as_css_value_at_rule_named_import_specifier(
        ...
        match &self {
            Self::CssValueAtRuleNamedImportSpecifier(item) => {
                Some(item)
            }
            _ => None,
        }
...
impl AstNode for AnyCssAtRule {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_CONTAINER_AT_RULE => {
                Self::CssContainerAtRule(CssContainerAtRule { syntax })
            }
            CSS_COUNTER_STYLE_AT_RULE => {
...
impl AstNode for AnyCssCompoundSelector {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_SELECTOR => {
                Self::CssBogusSelector(CssBogusSelector { syntax })
            }
            CSS_COMPOUND_SELECTOR => {
                Self::CssCompoundSelector(CssCompoundSelector { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_DECLARATION_OR_RULE_BLOCK => {
                Self::CssDeclarationOrRuleBlock(CssDeclarationOrRuleBlock {
                    syntax,
                })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_CONTAINER_AND_QUERY => {
                Self::CssContainerAndQuery(CssContainerAndQuery {
                    syntax,
                })
            }
            _ => {
                ...
                {
                    return Some(
                        Self::AnyCssContainerQueryInParens(
...
impl std::fmt::Debug for AnyCssContainerAndCombinableQuery {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::AnyCssContainerQueryInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssContainerAndQuery(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_CONTAINER_OR_QUERY => {
                Self::CssContainerOrQuery(CssContainerOrQuery {
                    syntax,
                })
            }
            _ => {
...
impl AstNode for AnyCssContainerQuery {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_CONTAINER_AND_QUERY => {
                Self::CssContainerAndQuery(CssContainerAndQuery { syntax })
            }
            CSS_CONTAINER_NOT_QUERY => {
                Self::CssContainerNotQuery(CssContainerNotQuery { syntax })
            }
            CSS_CONTAINER_OR_QUERY => {
                Self::CssContainerOrQuery(CssContainerOrQuery { syntax })
            }
            _ => {
                if let Some(any_css_container_query_in_parens) =
                    AnyCssContainerQueryInParens::cast(syntax)
...
impl AstNode for AnyCssContainerQueryInParens {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_CONTAINER_QUERY_IN_PARENS => {
                Self::CssContainerQueryInParens(CssContainerQueryInParens {
                    syntax,
                })
            }
            CSS_CONTAINER_SIZE_FEATURE_IN_PARENS => {
                Self::CssContainerSizeFeatureInParens(
                    CssContainerSizeFeatureInParens { syntax },
                )
            }
            CSS_CONTAINER_STYLE_QUERY_IN_PARENS => {
                Self::CssContainerStyleQueryInParens(
...
impl std::fmt::Debug for AnyCssContainerQueryInParens {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssContainerQueryInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssContainerSizeFeatureInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssContainerStyleQueryInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl std::fmt::Debug for AnyCssContainerStyleAndCombinableQuery {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssContainerStyleAndQuery(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssContainerStyleInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssContainerStyleInParens {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_DECLARATION => {
                Self::CssDeclaration(CssDeclaration { syntax })
            }
            _ => {
...
impl std::fmt::Debug for AnyCssContainerStyleInParens {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::AnyCssContainerStyleQuery(it) => {
                std::fmt::Debug::fmt(it, f)
            }
...
impl std::fmt::Debug for AnyCssContainerStyleOrCombinableQuery {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssContainerStyleOrQuery(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssContainerStyleQuery {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_CONTAINER_STYLE_AND_QUERY => {
                Self::CssContainerStyleAndQuery(CssContainerStyleAndQuery {
                    syntax,
                })
            }
            CSS_CONTAINER_STYLE_IN_PARENS => {
                Self::CssContainerStyleInParens(CssContainerStyleInParens {
                    syntax,
                })
            }
            CSS_CONTAINER_STYLE_NOT_QUERY => {
                Self::CssContainerStyleNotQuery(CssContainerStyleNotQuery {
                    syntax,
                })
            }
            CSS_CONTAINER_STYLE_OR_QUERY => {
                Self::CssContainerStyleOrQuery(CssContainerStyleOrQuery {
                    syntax,
                })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_CUSTOM_IDENTIFIER => {
                Self::CssBogusCustomIdentifier(CssBogusCustomIdentifier {
                    syntax,
                })
            }
            CSS_CUSTOM_IDENTIFIER => {
                Self::CssCustomIdentifier(CssCustomIdentifier { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_DECLARATION_BLOCK => {
                Self::CssDeclarationBlock(CssDeclarationBlock { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_DASHED_IDENTIFIER => {
                Self::CssDashedIdentifier(CssDashedIdentifier { syntax })
            }
            CSS_IDENTIFIER => Self::CssIdentifier(CssIdentifier { syntax }),
            _ => return None,
        };
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_DECLARATION_WITH_SEMICOLON => {
                Self::CssDeclarationWithSemicolon(
...
impl std::fmt::Debug for AnyCssDeclarationOrAtRule {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssDeclarationWithSemicolon(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssDeclarationOrAtRuleBlock {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_BLOCK => {
                Self::CssBogusBlock(CssBogusBlock { syntax })
            }
            CSS_DECLARATION_OR_AT_RULE_BLOCK => {
                Self::CssDeclarationOrAtRuleBlock(
...
impl std::fmt::Debug for AnyCssDeclarationOrAtRuleBlock {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusBlock(it) => std::fmt::Debug::fmt(it, f),
            Self::CssDeclarationOrAtRuleBlock(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssDeclarationOrRule {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_DECLARATION_WITH_SEMICOLON => {
                Self::CssDeclarationWithSemicolon(CssDeclarationWithSemicolon {
                    syntax,
                })
            }
            CSS_EMPTY_DECLARATION => {
                Self::CssEmptyDeclaration(CssEmptyDeclaration { syntax })
            }
            CSS_METAVARIABLE => {
                Self::CssMetavariable(CssMetavariable { syntax })
            }
            _ => {
...
impl std::fmt::Debug for AnyCssDeclarationOrRuleBlock {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusBlock(it) => std::fmt::Debug::fmt(it, f),
            Self::CssDeclarationOrRuleBlock(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_REGULAR_DIMENSION => {
                Self::CssRegularDimension(CssRegularDimension { syntax })
            }
            CSS_UNKNOWN_DIMENSION => {
                Self::CssUnknownDimension(CssUnknownDimension { syntax })
            }
            _ => return None,
        };
        Some(res)
...
impl AstNode for AnyCssExpression {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BINARY_EXPRESSION => {
                Self::CssBinaryExpression(CssBinaryExpression { syntax })
            }
            CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION => {
                Self::CssListOfComponentValuesExpression(
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_FONT_FAMILY_NAME => {
                Self::CssFontFamilyName(CssFontFamilyName { syntax })
            }
            CSS_STRING => Self::CssString(CssString { syntax }),
            _ => return None,
        };
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_FONT_FEATURE_VALUES_BLOCK => {
                Self::CssFontFeatureValuesBlock(CssFontFeatureValuesBlock {
                    syntax,
                })
            }
            _ => return None,
...
impl std::fmt::Debug for AnyCssFontFeatureValuesBlock {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusBlock(it) => std::fmt::Debug::fmt(it, f),
            Self::CssFontFeatureValuesBlock(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_FONT_FEATURE_VALUES_ITEM => {
                Self::CssBogusFontFeatureValuesItem(
                    CssBogusFontFeatureValuesItem { syntax },
                )
            }
            CSS_FONT_FEATURE_VALUES_ITEM => {
                Self::CssFontFeatureValuesItem(CssFontFeatureValuesItem {
                    syntax,
                })
            }
            _ => return None,
...
impl std::fmt::Debug for AnyCssFontFeatureValuesItem {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusFontFeatureValuesItem(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssFontFeatureValuesItem(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_GENERIC_DELIMITER => {
                Self::CssGenericDelimiter(CssGenericDelimiter { syntax })
            }
            _ => {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_IMPORT_NAMED_LAYER => {
                Self::CssImportNamedLayer(CssImportNamedLayer { syntax })
            }
            _ => return None,
        };
        Some(res)
        ...
        let res = match syntax.kind() {
            ...
            _ => {
                if let Some(any_css_supports_condition) = AnyCssSupportsCondition::cast(syntax) {
                    return Some(Self::AnyCssSupportsCondition(
...
impl std::fmt::Debug for AnyCssImportSupportsCondition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::AnyCssSupportsCondition(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssDeclaration(it) => std::fmt::Debug::fmt(it, f),
        }
...
impl AstNode for AnyCssKeyframesBlock {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_BLOCK => Self::CssBogusBlock(CssBogusBlock { syntax }),
            CSS_KEYFRAMES_BLOCK => {
                Self::CssKeyframesBlock(CssKeyframesBlock { syntax })
            }
            _ => return None,
        };
        Some(res)
...
impl AstNode for AnyCssKeyframesItem {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_KEYFRAMES_ITEM => {
                Self::CssKeyframesItem(CssKeyframesItem { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_KEYFRAMES_SCOPE_FUNCTION => {
                Self::CssKeyframesScopeFunction(CssKeyframesScopeFunction {
                    syntax,
                })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_KEYFRAMES_IDENT_SELECTOR => {
                Self::CssKeyframesIdentSelector(CssKeyframesIdentSelector {
                    syntax,
                })
            }
            CSS_KEYFRAMES_PERCENTAGE_SELECTOR => {
                Self::CssKeyframesPercentageSelector(
...
impl std::fmt::Debug for AnyCssKeyframesSelector {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssKeyframesPercentageSelector(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_LAYER_DECLARATION => {
                Self::CssLayerDeclaration(CssLayerDeclaration { syntax })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_MEDIA_AND_CONDITION => {
                Self::CssMediaAndCondition(CssMediaAndCondition {
                    syntax,
                })
            }
            _ => {
                if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
                    return Some(Self::AnyCssMediaInParens(
...
impl std::fmt::Debug for AnyCssMediaAndCombinableCondition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::AnyCssMediaInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssMediaAndCondition(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssMediaCondition {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_MEDIA_AND_CONDITION => {
                Self::CssMediaAndCondition(CssMediaAndCondition { syntax })
            }
            CSS_MEDIA_NOT_CONDITION => {
                Self::CssMediaNotCondition(CssMediaNotCondition { syntax })
            }
            CSS_MEDIA_OR_CONDITION => {
                Self::CssMediaOrCondition(CssMediaOrCondition { syntax })
            }
            _ => {
                if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
                    return Some(Self::AnyCssMediaInParens(
...
impl AstNode for AnyCssMediaOrCombinableCondition {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_MEDIA_OR_CONDITION => {
                Self::CssMediaOrCondition(CssMediaOrCondition {
                    syntax,
                })
            }
            _ => {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_MEDIA_QUERY => {
                Self::CssBogusMediaQuery(CssBogusMediaQuery { syntax })
            }
            ...
            _ => {
                if let Some(any_css_media_type_query) = AnyCssMediaTypeQuery::cast(syntax) {
                    return Some(Self::AnyCssMediaTypeQuery(
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_MEDIA_AND_TYPE_QUERY => {
                Self::CssMediaAndTypeQuery(CssMediaAndTypeQuery { syntax })
            }
            CSS_MEDIA_TYPE_QUERY => {
                Self::CssMediaTypeQuery(CssMediaTypeQuery { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_UNIVERSAL_NAMESPACE_PREFIX => {
                Self::CssUniversalNamespacePrefix(CssUniversalNamespacePrefix {
                    syntax,
                })
            }
            _ => return None,
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_PAGE_AT_RULE_BLOCK => {
                Self::CssPageAtRuleBlock(CssPageAtRuleBlock { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_PAGE_SELECTOR_PSEUDO => {
                Self::CssBogusPageSelectorPseudo(CssBogusPageSelectorPseudo {
                    syntax,
                })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_COMPOSES_PROPERTY => {
                Self::CssComposesProperty(CssComposesProperty { syntax })
            }
            CSS_GENERIC_PROPERTY => {
                Self::CssGenericProperty(CssGenericProperty { syntax })
            }
            _ => return None,
        };
        Some(res)
...
impl AstNode for AnyCssPseudoClass {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_PSEUDO_CLASS => {
                Self::CssBogusPseudoClass(CssBogusPseudoClass { syntax })
            }
            CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR => {
            ...
            CSS_PSEUDO_CLASS_FUNCTION_IDENTIFIER => {
                Self::CssPseudoClassFunctionIdentifier(
            ...
            CSS_PSEUDO_CLASS_FUNCTION_SELECTOR => {
                Self::CssPseudoClassFunctionSelector(CssPseudoClassFunctionSelector {
                    syntax,
                })
            }
            CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST => {
                Self::CssPseudoClassFunctionSelectorList(
                    CssPseudoClassFunctionSelectorList { syntax },
                )
            }
            CSS_PSEUDO_CLASS_FUNCTION_VALUE_LIST => {
                Self::CssPseudoClassFunctionValueList(
...
impl std::fmt::Debug for AnyCssPseudoClass {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssPseudoClassFunctionCompoundSelector(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssPseudoClassFunctionCompoundSelectorList(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssPseudoClassFunctionIdentifier(it) => std::fmt::Debug::fmt(it, f),
            Self::CssPseudoClassFunctionNth(it) => std::fmt::Debug::fmt(it, f),
            Self::CssPseudoClassFunctionRelativeSelectorList(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssPseudoClassFunctionSelector(it) => std::fmt::Debug::fmt(it, f),
            Self::CssPseudoClassFunctionSelectorList(it) => {
                std::fmt::Debug::fmt(it, f)
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_PSEUDO_CLASS_NTH => {
                Self::CssPseudoClassNth(CssPseudoClassNth { syntax })
            }
            CSS_PSEUDO_CLASS_NTH_IDENTIFIER => {
                Self::CssPseudoClassNthIdentifier(CssPseudoClassNthIdentifier {
                    syntax,
                })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_PSEUDO_CLASS_NTH_SELECTOR => {
                Self::CssPseudoClassNthSelector(CssPseudoClassNthSelector {
                    syntax,
                })
            }
            _ => return None,
...
impl std::fmt::Debug for AnyCssPseudoClassNthSelector {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusSelector(it) => std::fmt::Debug::fmt(it, f),
            Self::CssPseudoClassNthSelector(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssPseudoElement {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_PSEUDO_ELEMENT_FUNCTION_IDENTIFIER => {
                Self::CssPseudoElementFunctionIdentifier(
                    CssPseudoElementFunctionIdentifier { syntax },
                )
            }
            CSS_PSEUDO_ELEMENT_FUNCTION_SELECTOR => {
                Self::CssPseudoElementFunctionSelector(
                    CssPseudoElementFunctionSelector { syntax },
                )
            }
            CSS_PSEUDO_ELEMENT_IDENTIFIER => {
                Self::CssPseudoElementIdentifier(CssPseudoElementIdentifier {
                    syntax,
                })
            }
            _ => return None,
...
impl std::fmt::Debug for AnyCssPseudoElement {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssPseudoElementFunctionIdentifier(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssPseudoElementFunctionSelector(it) => {
                std::fmt::Debug::fmt(it, f)
            }
...
impl AstNode for AnyCssQueryFeature {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_QUERY_FEATURE_PLAIN => {
                Self::CssQueryFeaturePlain(CssQueryFeaturePlain { syntax })
            }
            CSS_QUERY_FEATURE_RANGE => {
                Self::CssQueryFeatureRange(CssQueryFeatureRange { syntax })
            }
            CSS_QUERY_FEATURE_RANGE_INTERVAL => {
                Self::CssQueryFeatureRangeInterval(CssQueryFeatureRangeInterval {
                    syntax,
                })
            }
            CSS_QUERY_FEATURE_REVERSE_RANGE => {
                Self::CssQueryFeatureReverseRange(CssQueryFeatureReverseRange {
                    syntax,
                })
            }
            _ => return None,
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_RELATIVE_SELECTOR => {
                Self::CssRelativeSelector(CssRelativeSelector { syntax })
            }
            _ => return None,
        };
        Some(res)
...
impl AstNode for AnyCssScopeRange {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_SCOPE_RANGE => {
                Self::CssBogusScopeRange(CssBogusScopeRange { syntax })
            }
            ...
            CSS_SCOPE_RANGE_START => {
                Self::CssScopeRangeStart(CssScopeRangeStart { syntax })
            }
            _ => return None,
        };
        Some(res)
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_COMPLEX_SELECTOR => {
                Self::CssComplexSelector(CssComplexSelector { syntax })
            }
            CSS_COMPOUND_SELECTOR => {
                Self::CssCompoundSelector(CssCompoundSelector { syntax })
            }
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_UNIVERSAL_SELECTOR => {
                Self::CssUniversalSelector(CssUniversalSelector { syntax })
            }
            _ => return None,
        };
        Some(res)
...
impl AstNode for AnyCssSubSelector {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_ATTRIBUTE_SELECTOR => {
                Self::CssAttributeSelector(CssAttributeSelector { syntax })
            }
            CSS_BOGUS_SUB_SELECTOR => {
                Self::CssBogusSubSelector(CssBogusSubSelector { syntax })
            }
...
impl std::fmt::Debug for AnyCssSupportsAndCombinableCondition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::AnyCssSupportsInParens(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssSupportsAndCondition(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssSupportsCondition {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            _ => {
                if let Some(any_css_supports_in_parens) = AnyCssSupportsInParens::cast(syntax) {
                    return Some(Self::AnyCssSupportsInParens(
                        any_css_supports_in_parens,
                    ));
                }
                return None;
...
impl AstNode for AnyCssSupportsInParens {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_FUNCTION => Self::CssFunction(CssFunction { syntax }),
            CSS_SUPPORTS_CONDITION_IN_PARENS => {
                Self::CssSupportsConditionInParens(CssSupportsConditionInParens {
                    syntax,
                })
            }
            CSS_SUPPORTS_FEATURE_DECLARATION => {
                Self::CssSupportsFeatureDeclaration(
                    CssSupportsFeatureDeclaration { syntax },
                )
            }
            CSS_SUPPORTS_FEATURE_SELECTOR => {
                Self::CssSupportsFeatureSelector(CssSupportsFeatureSelector {
                    syntax,
                })
            }
            _ => {
...
impl std::fmt::Debug for AnyCssSupportsInParens {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssSupportsFeatureDeclaration(it) => {
                std::fmt::Debug::fmt(it, f)
            }
...
impl std::fmt::Debug for AnyCssSupportsOrCombinableCondition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CssSupportsOrCondition(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssUnicodeValue {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            CSS_UNICODE_CODEPOINT => {
                Self::CssUnicodeCodepoint(CssUnicodeCodepoint { syntax })
            }
            CSS_UNICODE_RANGE_INTERVAL => {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_URL_MODIFIER => {
                Self::CssBogusUrlModifier(CssBogusUrlModifier { syntax })
            }
            CSS_FUNCTION => Self::CssFunction(CssFunction { syntax }),
            CSS_IDENTIFIER => Self::CssIdentifier(CssIdentifier { syntax }),
            _ => return None,
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_VALUE_AT_RULE_DECLARATION_CLAUSE => {
                Self::CssValueAtRuleDeclarationClause(
                    CssValueAtRuleDeclarationClause { syntax },
                )
            }
            CSS_VALUE_AT_RULE_IMPORT_CLAUSE => {
                Self::CssValueAtRuleImportClause(CssValueAtRuleImportClause {
                    syntax,
                })
            }
            _ => return None,
...
impl std::fmt::Debug for AnyCssValueAtRuleClause {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssValueAtRuleDeclarationClause(it) => {
                std::fmt::Debug::fmt(it, f)
            }
...
impl AstNode for AnyCssValueAtRuleImportSource {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_IDENTIFIER => {
                Self::CssIdentifier(CssIdentifier { syntax })
            }
            CSS_STRING => Self::CssString(CssString { syntax }),
            _ => return None,
        };
...
impl std::fmt::Debug for AnyCssValueAtRuleImportSpecifier {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssValueAtRuleImportSpecifier(it) => {
                std::fmt::Debug::fmt(it, f)
            }
            Self::CssValueAtRuleNamedImportSpecifier(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
...
impl AstNode for AnyCssValueAtRuleProperty {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            CSS_BOGUS_PROPERTY => {
                Self::CssBogusProperty(CssBogusProperty { syntax })
            }
            CSS_VALUE_AT_RULE_GENERIC_PROPERTY => {
                Self::CssValueAtRuleGenericProperty(
...
impl std::fmt::Debug for AnyCssValueAtRuleProperty {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::CssBogusProperty(it) => std::fmt::Debug::fmt(it, f),
            Self::CssValueAtRuleGenericProperty(it) => {
                std::fmt::Debug::fmt(it, f)
            }
        }
    }
