...
impl CssAtRule {
    pub fn with_name(self, element: CssAtKeyword) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_prelude(self, element: CssAtRuleComponentValue) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_css_at_rule_content(self, element: CssAtRuleContent) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl CssBlockDeclarationList {
    pub fn with_css_declaration_list(self, element: CssDeclarationList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssCurlyBracketsBlock {
    ...
    pub fn with_content(self, element: CssCurlyBracketsBlockContent) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssDeclaration {
    ...
    pub fn with_valie(self, element: CssComponentValueList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssFunctionBlock {
    pub fn with_css_function_token(self, element: CssFunctionToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssFunctionToken {
    pub fn with_valye_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl CssQualifiedRule {
    pub fn with_prelude(self, element: CssQualifiedRulePrelude) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_block(self, element: CssCurlyBracketsBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssSimpleCurlyBracketsBlock {
    ...
    pub fn with_content(self, element: CssSimpleComponentValueList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssStyleSheet {
    ...
    pub fn with_content(self, element: CssStyleSheetContent) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
