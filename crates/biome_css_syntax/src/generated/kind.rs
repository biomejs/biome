...
pub enum CssSyntaxKind {
    ...
    CSS_COMPOSES_PROPERTY_VALUE_LIST,
    ...
    CSS_CUSTOM_IDENTIFIER_COMMA_SEPARATED_LIST,
    ...
    SCSS_EXTEND_TARGET_TOKEN,
    SCSS_EXTEND_TARGET_VALUE,
    ...
    SCSS_MODULE_CONFIGURATION_LIST,
    SCSS_MODULE_CONFIGURATION_ITEM_LIST,
    SCSS_MODULE_MEMBER_LIST,
    SCSS_PARAMETER_LIST,
    SCSS_PARAMETER_ITEM_LIST,
    SCSS_PARAMETER,
    SCSS_PARAMETER_DEFAULT_VALUE,
    SCSS_KEYFRAMES_NAME,
    ...
    SCSS_INTERPOLATED_URL_VALUE_PART_LIST,
    ...
    SCSS_VARIABLE,
    SCSS_NAMESPACED_VARIABLE,
    SCSS_MODULE_MEMBER_ACCESS,
...
impl CssSyntaxKind {
    ...
    pub fn from_keyword(ident: &str) -> Option<Self> {
        let kw = match ident {
            ...
            "entry" => ENTRY_KW,
            "exit" => EXIT_KW,
            "entry-crossing" => ENTRY_CROSSING_KW,
            "exit-crossing" => EXIT_CROSSING_KW,
            "through" => THROUGH_KW,
            "var" => VAR_KW,
            "url" => URL_KW,
            "if" => IF_KW,
            ...
            "utility" => UTILITY_KW,
            "variant" => VARIANT_KW,
            "custom-variant" => CUSTOM_VARIANT_KW,
            "apply" => APPLY_KW,
            "source" => SOURCE_KW,
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            ENTRY_KW => "entry",
            EXIT_KW => "exit",
            ENTRY_CROSSING_KW => "entry-crossing",
            EXIT_CROSSING_KW => "exit-crossing",
            THROUGH_KW => "through",
            VAR_KW => "var",
            URL_KW => "url",
            IF_KW => "if",
            ...
            UTILITY_KW => "utility",
            VARIANT_KW => "variant",
            CUSTOM_VARIANT_KW => "custom-variant",
            APPLY_KW => "apply",
            SOURCE_KW => "source",
