...
impl CssSyntaxKind {
    ...
    pub fn from_keyword(ident: &str) -> Option<CssSyntaxKind> {
        let kw = match ident {
            ...
            "global" => GLOBAL_KW,
            "mozany" => MOZANY_KW,
            "webkitany" => WEBKITANY_KW,
            "current" => CURRENT_KW,
            "past" => PAST_KW,
            "future" => FUTURE_KW,
            "host" => HOST_KW,
            "hostcontext" => HOSTCONTEXT_KW,
            "matches" => MATCHES_KW,
            "is" => IS_KW,
            "where" => WHERE_KW,
            "has" => HAS_KW,
            "lang" => LANG_KW,
            "nthchild" => NTHCHILD_KW,
            "nthlastchild" => NTHLASTCHILD_KW,
            "nthoftype" => NTHOFTYPE_KW,
            "nthlastoftype" => NTHLASTOFTYPE_KW,
            "nthcol" => NTHCOL_KW,
            "nthlastcol" => NTHLASTCOL_KW,
            "charset" => CHARSET_KW,
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            GLOBAL_KW => "global",
            MOZANY_KW => "mozany",
            WEBKITANY_KW => "webkitany",
            CURRENT_KW => "current",
            PAST_KW => "past",
            FUTURE_KW => "future",
            HOST_KW => "host",
            HOSTCONTEXT_KW => "hostcontext",
            MATCHES_KW => "matches",
            IS_KW => "is",
            WHERE_KW => "where",
            HAS_KW => "has",
            LANG_KW => "lang",
            NTHCHILD_KW => "nthchild",
            NTHLASTCHILD_KW => "nthlastchild",
            NTHOFTYPE_KW => "nthoftype",
            NTHLASTOFTYPE_KW => "nthlastoftype",
            NTHCOL_KW => "nthcol",
            NTHLASTCOL_KW => "nthlastcol",
            CHARSET_KW => "charset",
