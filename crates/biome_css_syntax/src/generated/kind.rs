...
impl CssSyntaxKind {
    ...
    pub fn from_keyword(ident: &str) -> Option<CssSyntaxKind> {
        let kw = match ident {
            ...
            "local" => LOCAL_KW,
            "global" => GLOBAL_KW,
            "_moz_any" => _MOZ_ANY_KW,
            "_webkit_any" => _WEBKIT_ANY_KW,
            "current" => CURRENT_KW,
            "past" => PAST_KW,
            "future" => FUTURE_KW,
            "host" => HOST_KW,
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            LOCAL_KW => "local",
            GLOBAL_KW => "global",
            _MOZ_ANY_KW => "_moz_any",
            _WEBKIT_ANY_KW => "_webkit_any",
            CURRENT_KW => "current",
            PAST_KW => "past",
            FUTURE_KW => "future",
            HOST_KW => "host",
