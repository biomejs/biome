...
pub enum CssSyntaxKind {
    ...
    INTEGER_KW,
    LENGTH_KW,
    LENGTH_PERCENTAGE_KW,
    PERCENTAGE_KW,
    RESOLUTION_KW,
    STRING_KW,
    TIME_KW,
    TRANSFORM_FUNCTION_KW,
    INITIAL_KW,
    INHERIT_KW,
    UNSET_KW,
    REVERT_KW,
...
impl CssSyntaxKind {
    ...
    pub fn from_keyword(ident: &str) -> Option<Self> {
        let kw = match ident {
            ...
            "angle" => ANGLE_KW,
            "color" => COLOR_KW,
            "custom-ident" => CUSTOM_IDENT_KW,
            "image" => IMAGE_KW,
            "integer" => INTEGER_KW,
            "length" => LENGTH_KW,
            "length-percentage" => LENGTH_PERCENTAGE_KW,
            "percentage" => PERCENTAGE_KW,
            "resolution" => RESOLUTION_KW,
            "string" => STRING_KW,
            "time" => TIME_KW,
            "transform-function" => TRANSFORM_FUNCTION_KW,
            "initial" => INITIAL_KW,
            "inherit" => INHERIT_KW,
            "unset" => UNSET_KW,
            "revert" => REVERT_KW,
    ...
    pub const fn to_string(&self) -> Option<&'static str> {
        let tok = match self {
            ...
            ANGLE_KW => "angle",
            COLOR_KW => "color",
            CUSTOM_IDENT_KW => "custom-ident",
            IMAGE_KW => "image",
            INTEGER_KW => "integer",
            LENGTH_KW => "length",
            LENGTH_PERCENTAGE_KW => "length-percentage",
            PERCENTAGE_KW => "percentage",
            RESOLUTION_KW => "resolution",
            STRING_KW => "string",
            TIME_KW => "time",
            TRANSFORM_FUNCTION_KW => "transform-function",
            INITIAL_KW => "initial",
            INHERIT_KW => "inherit",
            UNSET_KW => "unset",
            REVERT_KW => "revert",
