...
pub const UNSUPPORTED_RULES: &[UnsupportedRule] = &[
    ...
    UnsupportedRule(Eslint("array-bracket-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(Eslint("computed-property-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(Eslint("space-in-brackets"), FormatterOption("delimiterSpacing")),
    UnsupportedRule(Eslint("space-in-parens"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(Eslint("template-curly-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintReact("jsx-curly-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintStylistic("array-bracket-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintStylistic("computed-property-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintStylistic("jsx-curly-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintStylistic("space-in-brackets"), FormatterOption("delimiterSpacing")),
    UnsupportedRule(EslintStylistic("space-in-parens"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintStylistic("template-curly-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintVueJs("array-bracket-spacing"), FormatterOption("delimiterSpacing")),
    ...
    UnsupportedRule(EslintVueJs("space-in-parens"), FormatterOption("delimiterSpacing")),
    UnsupportedRule(EslintVueJs("space-infix-ops"), FormatterCovers),
    UnsupportedRule(EslintVueJs("space-unary-ops"), FormatterCovers),
    UnsupportedRule(EslintVueJs("template-curly-spacing"), FormatterOption("delimiterSpacing")),
