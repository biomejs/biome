...
pub struct YamlBlockMappingBuilder {
    yaml_indent: YamlIndent,
    entries: YamlBlockMapEntryList,
    yaml_dedent: Option<YamlDedent>,
}
impl YamlBlockMappingBuilder {
    pub fn with_yaml_dedent(mut self, yaml_dedent: YamlDedent) -> Self {
        self.yaml_dedent = Some(yaml_dedent);
        self
    }
    pub fn build(self) -> YamlBlockMapping {
        YamlBlockMapping::unwrap_cast(SyntaxNode::new_detached(
            ...
            [
                Some(SyntaxElement::Node(self.yaml_indent.into_syntax())),
...
pub struct YamlBlockSequenceBuilder {
    ...
    yaml_indent: Option<YamlIndent>,
    yaml_dedent: Option<YamlDedent>,
}
impl YamlBlockSequenceBuilder {
    pub fn with_yaml_indent(mut self, yaml_indent: YamlIndent) -> Self {
        self.yaml_indent = Some(yaml_indent);
        self
    }
    pub fn with_yaml_dedent(mut self, yaml_dedent: YamlDedent) -> Self {
        self.yaml_dedent = Some(yaml_dedent);
...
pub fn yaml_dedent(value_token: SyntaxToken) -> YamlDedent {
    YamlDedent::unwrap_cast(SyntaxNode::new_detached(
        YamlSyntaxKind::YAML_DEDENT,
        [Some(SyntaxElement::Token(value_token))],
    ))
}
...
pub fn yaml_indent(value_token: SyntaxToken) -> YamlIndent {
    YamlIndent::unwrap_cast(SyntaxNode::new_detached(
        YamlSyntaxKind::YAML_INDENT,
        [Some(SyntaxElement::Token(value_token))],
    ))
}
