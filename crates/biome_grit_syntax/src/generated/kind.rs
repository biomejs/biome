...
pub enum GritSyntaxKind {
    ...
    GRIT_MAP_ELEMENT,
    GRIT_MAP_ACCESSOR,
    GRIT_MAP_ACCESSOR_SUBJECT,
    GRIT_MAP_KEY,
    GRIT_LIST,
    GRIT_LIST_PATTERN_LIST,
    GRIT_LIST_ACCESSOR,
    GRIT_LIST_ACCESSOR_SUBJECT,
    GRIT_LIST_INDEX,
    GRIT_DOT,
    GRIT_DOTDOTDOT,
    GRIT_SOME,
...
impl GritSyntaxKind {
    pub const fn is_punct(self) -> bool {
        match self {
            DOLLAR_DOT3 | DOLLAR_UNDERSCORE | MATCH | SEMICOLON | COMMA | L_PAREN | R_PAREN
            | L_CURLY | R_CURLY | L_BRACK | R_BRACK | L_ANGLE | R_ANGLE | PLUS | STAR | SLASH
            | PERCENT | DOT | COLON | EQ | EQ2 | FAT_ARROW | BANG | NEQ | MINUS | LTEQ | GTEQ
            | PLUSEQ | BACKTICK => true,
            _ => false,
        }
    }
    pub const fn is_literal(self) -> bool {
        match self {
            ...
            | GRIT_STRING_LITERAL
            | GRIT_REGEX_LITERAL
            | GRIT_SNIPPET_REGEX_LITERAL => true,
            _ => false,
        }
    }
