...
[cargo-badge]: https://badgen.net/crates/v/biome_tailwind_parser?&color=green
[cargo-url]: https://crates.io/crates/biome_tailwind_parser/

</div>

# `biome_tailwind_parser`

Biome's Tailwind parser. Follow the [documentation](https://docs.rs/biome_tailwind_parser/).
