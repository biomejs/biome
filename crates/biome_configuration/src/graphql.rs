...
pub struct GraphqlConfiguration {
    ...
    #[cfg_attr(feature = "cli", bpaf(external(graphql_formatter_configuration), optional))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub formatter: Option<GraphqlFormatterConfiguration>,

    // GraphQL linter options
    #[cfg_attr(feature = "cli", bpaf(external(graphql_linter_configuration), optional))]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub linter: Option<GraphqlLinterConfiguration>,

    /// Assist options
    #[cfg_attr(feature = "cli", bpaf(external(graphql_assist_configuration), optional))]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GraphqlFormatterConfiguration {
    ...
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-enabled"), argument("true|false")))]
    pub enabled: Option<GraphqlFormatterEnabled>,

    /// The indent style applied to GraphQL files.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-indent-style"), argument("tab|space")))]
    pub indent_style: Option<IndentStyle>,

    /// The size of the indentation applied to GraphQL files. Default to 2.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-indent-width"), argument("NUMBER")))]
    pub indent_width: Option<IndentWidth>,

    /// The type of line ending applied to GraphQL files. `auto` uses CRLF on Windows and LF on other platforms.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-line-ending"), argument("lf|crlf|cr|auto")))]
    pub line_ending: Option<LineEnding>,

    /// What's the max width of a line applied to GraphQL files. Defaults to 80.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-line-width"), argument("NUMBER")))]
    pub line_width: Option<LineWidth>,

    /// The type of quotes used in GraphQL code. Defaults to double.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-quote-style"), argument("double|single")))]
    ...
    ///
    /// Defaults to true.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-formatter-trailing-newline"), argument("true|false")))]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GraphqlLinterConfiguration {
    /// Control the formatter for GraphQL files.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-linter-enabled"), argument("true|false")))]
...
pub struct GraphqlAssistConfiguration {
    /// Control the formatter for GraphQL files.
    #[cfg_attr(feature = "cli", bpaf(long("graphql-assist-enabled"), argument("true|false")))]
