...
static REACT_FILTERS: LazyLock<Vec<RuleFilter<'static>>> = LazyLock::new(|| {
    vec![
        ...
        RuleFilter::Rule("nursery", "noReactLeakedEventListener"),
        RuleFilter::Rule("nursery", "noReactLeakedIntersectionObserver"),
        RuleFilter::Rule("nursery", "noReactLeakedInterval"),
        RuleFilter::Rule("nursery", "noReactLeakedResizeObserver"),
        RuleFilter::Rule("nursery", "noReactLeakedTimeout"),
