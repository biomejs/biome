...
impl Suspicious {
    ...
    pub(crate) const GROUP_RULES: [&'static str; 54] = [
    ...
    const RECOMMENDED_RULES: [&'static str; 50] = [
        "noApproximativeNumericConstant",
        "noArrayIndexKey",
        "noAssignInExpressions",
        "noAsyncPromiseExecutor",
    ...
    const RECOMMENDED_RULES_AS_FILTERS: [RuleFilter<'static>; 50] = [
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[0]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[1]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[2]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[3]),
    ...
    const ALL_RULES_AS_FILTERS: [RuleFilter<'static>; 54] = [
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[0]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[1]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[2]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[3]),
    ...
    pub(crate) fn recommended_rules_as_filters() -> [RuleFilter<'static>; 50] {
        Self::RECOMMENDED_RULES_AS_FILTERS
    }
