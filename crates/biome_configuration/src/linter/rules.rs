...
pub struct Nursery {
    ...
    #[doc = "This rule allows you to enforce curly braces or disallow unnecessary curly braces in JSX props and/or children."]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub use_jsx_curly_brace_convention: Option<RuleFixConfiguration<UseJsxCurlyBraceConvention>>,
...
impl Nursery {
    ...
    pub(crate) fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.use_jsx_curly_brace_convention.as_ref() {
            if rule.is_enabled() {
    ...
    pub(crate) fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "useImportRestrictions" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useJsxCurlyBraceConvention" => self
                .use_jsx_curly_brace_convention
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
