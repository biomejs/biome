...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoUndeclaredStyles => "noUndeclaredStyles",
            ...
            Self::NoUnusedStyles => "noUnusedStyles",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoUndeclaredStyles => RuleGroup::Nursery,
            ...
            Self::NoUnusedStyles => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noUndeclaredStyles" => Ok(Self::NoUndeclaredStyles),
            ...
            "noUnusedStyles" => Ok(Self::NoUnusedStyles),
