...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoUnnormalizedObjectKeys => "noUnnormalizedObjectKeys",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoUnnormalizedObjectKeys => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noUnnormalizedObjectKeys" => Ok(Self::NoUnnormalizedObjectKeys),
