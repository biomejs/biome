...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PreferClasslist => "preferClasslist",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::PreferClasslist => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "preferClasslist" => Ok(Self::PreferClasslist),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.prefer_classlist.as_ref() {
            if rule.is_enabled() {
                index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[28]));
            }
        }
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            prefer_classlist: Some(value.into()),
