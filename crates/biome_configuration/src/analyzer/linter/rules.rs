...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoBiomeFirstExpection => "noBiomeFirstExpection",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoBiomeFirstExpection => RuleGroup::Nursery,
            ...
            Self::UseBiomeIgnoreFolder => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noBiomeFirstExpection" => Ok(Self::NoBiomeFirstExpection),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.no_biome_first_expection.as_ref() {
            if rule.is_enabled() {
                index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[1]));
            }
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            "noAwaitInLoop" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noBiomeFirstExpection" => self
                .no_biome_first_expection
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            no_biome_first_expection: Some(value.into()),
