...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseDescriptionStyle => "useDescriptionStyle",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseDescriptionStyle => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useDescriptionStyle" => Ok(Self::UseDescriptionStyle),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.use_description_style.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[24]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "useConsistentTypeDefinitions" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useDescriptionStyle" => self
                .use_description_style
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            use_description_style: Some(value.into()),
