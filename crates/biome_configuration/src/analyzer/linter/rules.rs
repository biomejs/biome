...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoLeakedConditionalRendering => "noLeakedConditionalRendering",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoLeakedConditionalRendering => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noLeakedConditionalRendering" => Ok(Self::NoLeakedConditionalRendering),
...
=======
        ...
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[46]),
        RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[47]),
>>>>>>> 748e948166f9ec5685458dd633fe0060781d886a
    ];
}
...
<<<<<<< HEAD
        if let Some(rule) = self.no_leaked_conditional_rendering.as_ref()
=======
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "noJsxLiterals" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noLeakedConditionalRendering" => self
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            no_leaked_conditional_rendering: Some(value.into()),
