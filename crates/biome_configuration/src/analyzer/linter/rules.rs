...
impl RuleName {
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoUnnecessaryTemplateExpression => RuleGroup::Complexity,
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "noThisInStatic" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "noUnnecessaryTemplateExpression" => self
