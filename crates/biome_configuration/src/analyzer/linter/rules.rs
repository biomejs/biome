...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseConsistentImportPaths => "useConsistentImportPaths",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseConsistentImportPaths => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useConsistentImportPaths" => Ok(Self::UseConsistentImportPaths),
