...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseSvelteKitRuneImports => "useSvelteKitRuneImports",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseSvelteKitRuneImports => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useSvelteKitRuneImports" => Ok(Self::UseSvelteKitRuneImports),
