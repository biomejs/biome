...
pub enum RuleName {
    ...
    UseConsistentIndexedObjectStyle,
...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseConsistentIndexedObjectStyle => "useConsistentIndexedObjectStyle",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseConsistentIndexedObjectStyle => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useConsistentIndexedObjectStyle" => Ok(Self::UseConsistentIndexedObjectStyle),
