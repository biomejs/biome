...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoQwikReactProps => "noQwikReactProps",
            ...
            Self::UseJsxAnchorHref => "useJsxAnchorHref",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoQwikReactProps => RuleGroup::Nursery,
            ...
            Self::UseJsxAnchorHref => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noQwikReactProps" => Ok(Self::NoQwikReactProps),
            ...
            "useJsxAnchorHref" => Ok(Self::UseJsxAnchorHref),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.no_qwik_react_props.as_ref() {
            if rule.is_enabled() {
                index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[15]));
            }
        }
        ...
        if let Some(rule) = self.use_jsx_anchor_href.as_ref() {
            if rule.is_enabled() {
                index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[42]));
            }
        }
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            no_qwik_react_props: Some(value.into()),
            ...
            use_jsx_anchor_href: Some(value.into()),
