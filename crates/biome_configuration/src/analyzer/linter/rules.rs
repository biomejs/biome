...
pub enum RuleName {
    ...
    UseTopLevelRegex,
    UseTrimStartEnd,
    UseTypedIterableCallbackReturn,
    UseUnicodeRegex,
...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseTypedIterableCallbackReturn => "useTypedIterableCallbackReturn",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseTypedIterableCallbackReturn => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useTypedIterableCallbackReturn" => Ok(Self::UseTypedIterableCallbackReturn),
