...
pub enum RuleName {
    ...
    UseTanStackQueryExhaustiveDeps,
    UseTemplate,
    UseThrowNewError,
    UseThrowOnlyError,
    UseTopLevelRegex,
...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseTanStackQueryExhaustiveDeps => "useTanStackQueryExhaustiveDeps",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseTanStackQueryExhaustiveDeps => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useTanStackQueryExhaustiveDeps" => Ok(Self::UseTanStackQueryExhaustiveDeps),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.use_tan_stack_query_exhaustive_deps.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[28]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "useSortedClasses" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useTanStackQueryExhaustiveDeps" => self
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            use_tan_stack_query_exhaustive_deps: Some(value.into()),
