...
pub enum RuleName {
    ...
    UseHookAtTopLevel,
    UseHtmlLang,
    UseIfAsNullishCoalescingAssignment,
    UseIframeTitle,
    UseImageSize,
    UseImportExtensions,
    UseImportType,
    ...
    UseNullishCoalescingAssignment,
    UseNullishCoalescingInTernary,
    UseNumberNamespace,
...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseIfAsNullishCoalescingAssignment => "useIfAsNullishCoalescingAssignment",
            ...
            Self::UseNullishCoalescingAssignment => "useNullishCoalescingAssignment",
            Self::UseNullishCoalescingInTernary => "useNullishCoalescingInTernary",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseIfAsNullishCoalescingAssignment => RuleGroup::Style,
            ...
            Self::UseNullishCoalescing => RuleGroup::Style,
            Self::UseNullishCoalescingAssignment => RuleGroup::Style,
            Self::UseNullishCoalescingInTernary => RuleGroup::Style,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useIfAsNullishCoalescingAssignment" => Ok(Self::UseIfAsNullishCoalescingAssignment),
            ...
            "useNullishCoalescingAssignment" => Ok(Self::UseNullishCoalescingAssignment),
            "useNullishCoalescingInTernary" => Ok(Self::UseNullishCoalescingInTernary),
...
impl RuleGroupExt for Style {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.use_if_as_nullish_coalescing_assignment.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[53]));
        }
        ...
        if let Some(rule) = self.use_nullish_coalescing.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[59]));
        }
        if let Some(rule) = self.use_nullish_coalescing_assignment.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[60]));
        }
        if let Some(rule) = self.use_nullish_coalescing_in_ternary.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[61]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "useGroupedAccessorPairs" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useIfAsNullishCoalescingAssignment" => self
            ...
            "useNodejsImportProtocol" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useNullishCoalescing" => self
                .use_nullish_coalescing
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useNullishCoalescingAssignment" => self
                .use_nullish_coalescing_assignment
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useNullishCoalescingInTernary" => self
...
impl From<GroupPlainConfiguration> for Style {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            use_if_as_nullish_coalescing_assignment: Some(value.into()),
            ...
            use_nullish_coalescing: Some(value.into()),
            use_nullish_coalescing_assignment: Some(value.into()),
            use_nullish_coalescing_in_ternary: Some(value.into()),
