...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::NoReactLeakedIntersectionObserver => "noReactLeakedIntersectionObserver",
            Self::NoReactLeakedInterval => "noReactLeakedInterval",
            Self::NoReactLeakedResizeObserver => "noReactLeakedResizeObserver",
            Self::NoReactLeakedTimeout => "noReactLeakedTimeout",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::NoReactLeakedIntersectionObserver => RuleGroup::Nursery,
            Self::NoReactLeakedInterval => RuleGroup::Nursery,
            Self::NoReactLeakedResizeObserver => RuleGroup::Nursery,
            Self::NoReactLeakedTimeout => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "noReactLeakedIntersectionObserver" => Ok(Self::NoReactLeakedIntersectionObserver),
            "noReactLeakedInterval" => Ok(Self::NoReactLeakedInterval),
            "noReactLeakedResizeObserver" => Ok(Self::NoReactLeakedResizeObserver),
            "noReactLeakedTimeout" => Ok(Self::NoReactLeakedTimeout),
