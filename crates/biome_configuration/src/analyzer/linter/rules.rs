...
pub enum RuleName {
    ...
    UseForOf,
    UseFragmentSyntax,
    UseFunctionComponentDefinition,
    UseGenericFontNames,
    UseGetterReturn,
    UseGlobalThis,
...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseFunctionComponentDefinition => "useFunctionComponentDefinition",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseFunctionComponentDefinition => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useFunctionComponentDefinition" => Ok(Self::UseFunctionComponentDefinition),
