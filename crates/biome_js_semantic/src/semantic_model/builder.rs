...
pub struct SemanticModelBuilder {
    ...
    bindings_by_range: FxHashMap<(BindingKind, TextRange), usize>,
    /// maps a reference range to its bindings. usize points to SemanticModelBuilder::bindings vec
    bindings_by_reference_range: FxHashMap<TextRange, usize>,
    exported: FxHashSet<usize>,
    ...
    pub fn push_event(&mut self, e: SemanticEvent) {
        ...
        match e {
            ...
            DeclarationFound {
                ...
                self.bindings_by_range.insert((kind, range), binding_id);
            ...
            Read {
                ...
                self.bindings_by_reference_range.insert(range, binding_id);
            }
            HoistedRead {
                range,
                binding_id,
