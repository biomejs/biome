...
impl AngularDeferBlock {
    pub fn with_opening_block(self, element: AngularDeferOpeningBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_placeholder_clause(self, element: Option<AngularPlaceholderClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_loading_clause(self, element: Option<AngularLoadingClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_error_clause(self, element: Option<AngularErrorClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularDeferHydrateNeverClause {
    pub fn with_hydrate_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl AngularDeferOpeningBlock {
    ...
    pub fn with_parameters(self, element: Option<AngularDeferParameters>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularDeferParameters {
    ...
    pub fn with_clauses(self, element: AngularDeferClauseList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularDeferPrefetchOnClause {
    pub fn with_prefetch_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl AngularDeferPrefetchWhenClause {
    pub fn with_prefetch_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
...
impl AngularElseIfClause {
    ...
    pub fn with_condition(self, element: AngularIfParameters) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularErrorClause {
    ...
    pub fn with_error_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into()))),
        )
...
impl AngularEventBinding {
    ...
    pub fn with_name(self, element: AngularBindingName) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularIfAsClause {
    ...
    pub fn with_binding(self, element: HtmlTextExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularIfBlock {
    pub fn with_opening_block(self, element: AngularIfOpeningBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_else_if_clauses(self, element: AngularElseIfClauseList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_else_clause(self, element: Option<AngularElseClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularIfParameters {
    ...
    pub fn with_as_clause(self, element: Option<AngularIfAsClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularLetBlock {
    ...
    pub fn with_initializer(self, element: AngularLetInitializerClause) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularLoadingClause {
    ...
    pub fn with_loading_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into()))),
        )
    }
    pub fn with_parameters(self, element: Option<AngularLoadingParameters>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularLoadingParameters {
    ...
    pub fn with_clauses(self, element: AngularLoadingParameterClauseList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularMinimumTimeClause {
    pub fn with_minimum_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl AngularPlaceholderClause {
    ...
    pub fn with_placeholder_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into()))),
        )
    }
    pub fn with_parameters(self, element: Option<AngularPlaceholderParameters>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl AngularPlaceholderParameters {
    pub fn with_l_paren_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
    ...
    pub fn with_clause(self, element: AngularMinimumTimeClause) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl AngularTwoWayBinding {
    pub fn with_l_bracket_paren_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
    ...
    pub fn with_r_bracket_paren_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into()))),
        )
...
impl AstroClassDirective {
    ...
    pub fn with_value(self, element: AstroDirectiveValue) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl AstroClientDirective {
    pub fn with_client_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl AstroServerDirective {
    pub fn with_server_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl SvelteAwaitBlock {
    pub fn with_opening_block(self, element: SvelteAwaitOpeningBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_clauses(self, element: SvelteAwaitClausesList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_closing_block(self, element: SvelteAwaitClosingBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteAwaitCatchBlock {
    ...
    pub fn with_name(self, element: Option<HtmlTextExpression>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl SvelteAwaitOpeningBlock {
    ...
    pub fn with_then_clause(self, element: Option<SvelteAwaitThenClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_catch_clause(self, element: Option<SvelteAwaitCatchClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            4usize..=4usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl SvelteBindFunctionBindingExpression {
    ...
    pub fn with_get(self, element: HtmlTextExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_set(self, element: HtmlTextExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteBindFunctionBindingInitializerClause {
    ...
    pub fn with_value(self, element: SvelteBindFunctionBindingExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteDeclarationBlock {
    ...
    pub fn with_declaration(self, element: HtmlTextExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteDirectiveValue {
    ...
    pub fn with_initializer(self, element: Option<AnySvelteDirectiveInitializerClause>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl SvelteEachAsKeyedItem {
    ...
    pub fn with_index(self, element: Option<SvelteEachIndex>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_key(self, element: Option<SvelteEachKey>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl SvelteEachBlock {
    pub fn with_opening_block(self, element: SvelteEachOpeningBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_closing_block(self, element: SvelteEachClosingBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteEachOpeningBlock {
    ...
    pub fn with_list(self, element: HtmlTextExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_item(self, element: Option<AnySvelteBlockItem>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl SvelteSnippetBlock {
    ...
    pub fn with_closing_block(self, element: SvelteSnippetClosingBlock) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteSnippetClosingBlock {
    ...
    pub fn with_snippet_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into()))),
        )
...
impl SvelteTemplateAttributeValue {
    pub fn with_l_quote_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
    }
    pub fn with_elements(self, element: SvelteTemplateElementList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_r_quote_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into()))),
        )
...
impl SvelteTemplateChunkElement {
    pub fn with_html_template_chunk_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
...
impl VueVForArrayBinding {
    ...
    pub fn with_bindings(self, element: VueVForBindingList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl VueVForRestBinding {
    ...
    pub fn with_binding(self, element: VueVForIdentifierBinding) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
...
impl VueVForTupleBinding {
    ...
    pub fn with_value(self, element: AnyVueVForBinding) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_second(self, element: Option<VueVForTupleElement>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
    }
    pub fn with_third(self, element: Option<VueVForTupleElement>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            3usize..=3usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl VueVForValue {
    ...
    pub fn with_operator(self, element: AnyVueVForOperator) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
