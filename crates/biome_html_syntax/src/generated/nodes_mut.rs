...
impl SvelteSnippetExpression {
    ...
    pub fn with_parameters(self, element: SvelteSnippetParameterList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteSnippetOpeningBlock {
    ...
    pub fn with_expression(self, element: SvelteSnippetExpression) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl SvelteSnippetParameter {
    pub fn with_binding(self, element: AnySvelteBindingAssignmentBinding) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_default(self, element: Option<SvelteSnippetParameterDefaultValue>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
