...
impl<'a> RuleSource<'a> {
    ...
    pub const fn variant_index(&self) -> u16 {
        match self {
            ...
            Self::EslintBetterTailwindcss(_) => 4,
            Self::EslintGraphql(_) => 5,
            Self::EslintImport(_) => 6,
            Self::EslintImportAccess(_) => 7,
            Self::EslintJest(_) => 8,
            Self::EslintJsDoc(_) => 9,
            Self::EslintJsxA11y(_) => 10,
            Self::EslintMysticatea(_) => 11,
            Self::EslintN(_) => 12,
            Self::EslintNext(_) => 13,
            Self::EslintNoSecrets(_) => 14,
            Self::EslintPackageJson(_) => 15,
            Self::EslintPackageJsonDependencies(_) => 16,
            Self::EslintPerfectionist(_) => 17,
