...
[cargo-badge]: https://badgen.net/crates/v/biome_graphql_analyze?&color=green
[cargo-url]: https://crates.io/crates/biome_graphql_analyze/

</div>

# `biome_graphql_analyze`

Biome's GraphQL linter. Follow the [documentation](https://docs.rs/biome_graphql_analyze/).
