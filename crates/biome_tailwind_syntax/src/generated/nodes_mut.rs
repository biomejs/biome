...
use crate::{TailwindSyntaxToken as SyntaxToken, generated::nodes::*};
...
impl CssFunction {
    ...
    pub fn with_parameters(self, element: CssParameterList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl CssRatio {
    pub fn with_left(self, element: CssNumber) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    ...
    pub fn with_right(self, element: CssNumber) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl TwArbitraryCandidate {
    ...
    pub fn with_modifier(self, element: Option<AnyTwModifier>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            5usize..=5usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl TwFullCandidate {
    ...
    pub fn with_legacy_important_token(self, element: Option<SyntaxToken>) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl TwFunctionalCandidate {
    ...
    pub fn with_value(self, element: AnyTwValue) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl TwVariantExpression {
    pub fn with_segments(self, element: TwVariantSegmentList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_glued_value(self, element: Option<TwArbitraryVariantSegment>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            1usize..=1usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
