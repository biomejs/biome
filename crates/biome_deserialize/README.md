...
> [!NOTE]
> If you are curious about the code generated by the macro, _Rust Analyzer_ offers a great feature
...
impl DeserializationVisitor for UnionVisitor {
    ...
    const EXPECTED_TYPE: VisitableType = VisitableType::BOOL.with_str();
