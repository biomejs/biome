...
[cargo-badge]: https://badgen.net/crates/v/biome_rowan?&color=green
[cargo-url]: https://crates.io/crates/biome_rowan/

</div>

# `biome_rowan`

Biome's custom Rowan definition. Follow the [documentation](https://docs.rs/biome_rowan/).
